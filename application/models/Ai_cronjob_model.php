...
class Ai_cronjob_model extends CI_Model {
    ...
    public function get_assessment_users($company_id,$assessment_id,$assessment_type){
        ...
        if($assessment_type == 3){
            ...
            //KRISHNA -- 09.04.2024 -- MYSQL 8 fix increment query
            $query  = "SELECT
                    ...
                    CONCAT('Q', main.txn_id) as question_series,
                ...
                FROM(
                    SELECT DISTINCT
                        ...
                        CONCAT( du.firstname, ' ', du.lastname ) AS user_name,aq.question,ar.video_url,ar.vimeo_uri,ar.ftp_status,aa.is_completed,ats.txn_id 
                    FROM
                        ...
                        LEFT JOIN assessment_attempts AS aa ON ar.assessment_id = aa.assessment_id AND ar.user_id = aa.user_id 
                        LEFT JOIN assessment_trans_sparam AS ats ON ats.assessment_id = ar.assessment_id AND ats.question_id = aq.id 
                        WHERE
    ...
    public function get_task(){
        $query  = "SELECT ais.*,CONCAT( du.firstname, ' ', du.lastname ) AS user_name,CONCAT(du.firstname,' ',du.lastname,' ',du.user_id) AS user_name_id,c.portal_name,am.assessment,am.language_code as lang_flag from ai_schedule  as ais 
