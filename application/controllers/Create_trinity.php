...
class Create_trinity extends MY_Controller
{
    ...
    public function Check_assessment()
    {
       ...
       // $this->create_trinity_model->check_assessment($Company_id, $assessment, $assessment_type, $assessment_id);
        ...
        if (count((array)$final_txt) > 0) {
            ...
            if (count((array)$data) > 0) {
                echo $msg = "Assessment already exists!!";
            }
        } // Changes by  Shital Patel - Language module changes-22-02-2024
    ...
    public function fetch_question_answer($tr_no)
    {
        ...
        if (count((array)$script_id) > 0) {
            ...
            foreach ($fetch_question_answer as $fq) {
                ...
                $lchtml .= '<td><span class="notranslate"><select id="language_id' . $tr_no . '" name="language_id' . $tr_no . '" class="form-control input-sm ValueUnq language_id" style="width:100%" placeholder="Please select" style="width:100px;" disabled="disabled">';
                ...
                // }
                // $lchtml .= '</select></td>';
                $lchtml .= '<td><span class="notranslate"><select id="parameter_id' . $tr_no . '" name="New_parameter_id' . $tr_no . '[]" class="form-control input-sm ValueUnq verbleparameter" style="width:100%" multiple onchange="getUnique_paramters()">';
