...
class Consolidated_reports extends CI_Controller {
    public function __construct() {
        ...
        if ($this->session->userdata('awarathon_session') == FALSE) {
            ...
            $acces_management = CheckRights($this->mw_session['user_id'], 'consolidated_reports');
            if (!$acces_management->allow_access) {
                redirect('dashboard');
            }
            $this->acces_management = $acces_management;
            $this->load->model('consolidated_reports_model');
    ...
    public function index() {
        ...
        $this->load->view('consolidated_reports/index', $data);
    }
   public function ajax_companywise_data() {
    ...
    public function ajax_sessionswise_data() {
        ...
        $data['UserData'] = $this->consolidated_reports_model->get_userData($sessions_id,$workshop_id,$company_id);                
        echo json_encode($data);
    }
    public function DatatableRefresh() {
        ...
        $DTRenderArray = $this->consolidated_reports_model->LoadDataTable($dtWhere, $dtOrder, $dtLimit);
    ...
    public function exportReport() {//In use for Export
       ...
       // $data=$this->session->userdata('awarathon_session');
//        echo "<pre>";
//        print_r($data);exit;
        
        $i = 3;
        $j = 0;
        $Data_list = $this->consolidated_reports_model->exportToExcel($exportWhere);
