...
class Ai_process extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $data['user_details'] = $this->ai_process_model->get_participate_manager($assessment_id);
        $data['company_id'] = $this->mw_session['company_id'];
        // ai Reports
    ...
    public function CandidateDatatableRefresh($assessment_id, $is_send_tab)
    {
        ...
        $DTRenderArray = $this->ai_process_model->get_distinct_participants($company_id, $assessment_id, $division_id);
        $output = array(
            "sEcho" => $this->input->get('sEcho') ? $this->input->get('sEcho') : 0,
            "iTotalRecords" => $DTRenderArray['dtPerPageRecords'],
            "iTotalDisplayRecords" => $DTRenderArray['dtTotalRecords'],
    ...
    public function fetch_participants()
    {
        ...
        $_participants_result = $this->ai_process_model->get_distinct_participants($company_id, $asssessment_id, $division_id);
    ...
    function fetch_process_participants()
    {
        ...
        if ($assessment_type == 3) {
            ...
            $_participants_result = $this->ai_process_model->get_process_participants($company_id, $assessment_id, $start_date, $end_date, $division_id);
        }
    ...
    function load_assessment_datewise()
    {
        ...
        if ($IsCustom == "") {
            ...
            $_participants_result = $this->ai_process_model->get_process_participants($Company_id, $assessment_id, $startdate, $CurrentDate, $division_id);
        } else {
            $_participants_result = $this->ai_process_model->get_process_participants($Company_id, $assessment_id, $SDate, $EDate, $division_id);
        }
        $data['_participants_result'] = $_participants_result;
        $data['start_date'] = isset($start_date) ? $start_date : '';
        $data['end_date'] = isset($end_date) ? $end_date : '';
    ...
    function fetch_participants_ai_reports()
    {
        ...
        $_participants_result         = $this->ai_process_model->get_distinct_participants_ai_reports($company_id, $asssessment_id, $assessment_type, $division_id);
        $data['report_type']          = $report_type;
        $data['_participants_result'] = $_participants_result;
    ...
    function generate_report()
    {
        ...
        $parameter_score_result = $this->ai_process_model->get_parameters_report($company_id, $ass_id, $dep_name);
        foreach ($parameter_score_result as $psr) {
