...
class Supervisor_dashboard extends MY_Controller {

    public function __construct() {
        parent::__construct();
        $acces_management = $this->check_rights('supervisor_dashboard');
    ...
    public function index() {
        ...
        $this->load->view('supervisor_dashboard/index', $data);
    }
    ...
    public function getdashboardData() {
        ...
        $data['HLAdata1'] = $this->supervisor_dashboard_model->get_HighestLowestAvgCE($Company_id, $trainer_id, $RightsFlag, $WRightsFlag, '', '', $wrktype_id, $wsubtype_id, $flt_region_id, $subregion_id);
        if ($data['HLAdata1'] > 0) {
            $data['BestRegionq1'] = $this->supervisor_dashboard_model->get_BestRegion($Company_id, $trainer_id, $RightsFlag, $WRightsFlag, $data['HLAdata1']['MaxCE'], '', '', $wrktype_id, $wsubtype_id, $flt_region_id, $subregion_id);
            $WorstRegionq1 = $this->supervisor_dashboard_model->get_WorstRegion($Company_id, $trainer_id, $RightsFlag, $WRightsFlag, $data['HLAdata1']['MinCE'], '', '', $wrktype_id, $wsubtype_id, $flt_region_id, $subregion_id);
            if ($data['BestRegionq1'] == $WorstRegionq1) {
                $WorstRegionq1 = '-';
            }
            $data['WorstRegionq1'] = $WorstRegionq1;
        }
        $data['TotalWorkshop1'] = $this->supervisor_dashboard_model->get_TotalWorkshop($Company_id, $trainer_id, $RightsFlag, $WRightsFlag, '', '', $wrktype_id, $wsubtype_id, $flt_region_id, $subregion_id);


        $data['HLAdata2'] = $this->supervisor_dashboard_model->get_HighestLowestAvgCE($Company_id, $trainer_id, $RightsFlag, $WRightsFlag, $start_date, $end_date, $wrktype_id, $wsubtype_id, $flt_region_id, $subregion_id);
        if ($data['HLAdata2'] > 0) {
            $data['BestRegionq2'] = $this->supervisor_dashboard_model->get_BestRegion($Company_id, $trainer_id, $RightsFlag, $WRightsFlag, $data['HLAdata2']['MaxCE'], $start_date, $end_date, $wrktype_id, $wsubtype_id, $flt_region_id, $subregion_id);
            // echo $this->db->last_query();
            // exit;
            $WorstRegionq2 = $this->supervisor_dashboard_model->get_WorstRegion($Company_id, $trainer_id, $RightsFlag, $WRightsFlag, $data['HLAdata2']['MinCE'], $start_date, $end_date, $wrktype_id, $wsubtype_id, $flt_region_id, $subregion_id);
            if ($data['BestRegionq2'] == $WorstRegionq2) {
                $WorstRegionq2 = '-';
            }
            $data['WorstRegionq2'] = $WorstRegionq2;
        }
        $data['TotalWorkshop2'] = $this->supervisor_dashboard_model->get_TotalWorkshop($Company_id, $trainer_id, $RightsFlag, $WRightsFlag, $start_date, $end_date, $wrktype_id, $wsubtype_id, $flt_region_id, $subregion_id);
        $RegionWise = $this->supervisor_dashboard_model->get_RegionWisePerformance($Company_id, $trainer_id, $RightsFlag, $WRightsFlag, $start_date, $end_date, $wrktype_id, $wsubtype_id, $flt_region_id, $subregion_id);
        ...
        if (count((array)$RegionWise) > 0) {
            ...
            $data['region_graph'] = $this->load->view('supervisor_dashboard/region_report', $Rdata, true);
        } else {
            $data['region_graph'] = "";
        }
        $TypeWise = $this->supervisor_dashboard_model->get_WorkshoptypeWisePerformance($Company_id, $trainer_id, $RightsFlag, $WRightsFlag, $start_date, $end_date, $wrktype_id, $wsubtype_id, $flt_region_id, $subregion_id);
        if (count((array)$TypeWise) > 0) {
            ...
            $Rdata['label'] = json_encode($Rlabel);
            $Rdata['totallabel'] = count((array)$Rlabel);
            $data['type_graph'] = $this->load->view('supervisor_dashboard/workshoptype_report', $Rdata, true);
        } else {
            $data['type_graph'] = "";
        }
...
//        $region_id = $this->input->post('region_id', true);
        ...
        if ($rpt_period == "weekly") {
            if ($WeekStartDate != '' && $WeekEndDate != '') {
                $CEArraySet = $this->supervisor_dashboard_model->supervisor_index_weekly_monthly($company_id, $trainer_id, $RightsFlag, $WRightsFlag, $WeekStartDate, $WeekEndDate, $wrktype_id, $wsubtype_id, $flt_region_id, $subregion_id);
            ...
            $CEArraySet = $this->supervisor_dashboard_model->supervisor_index_yearly($company_id, $trainer_id, $RightsFlag, $WRightsFlag, $WeekStartDate, $WeekEndDate, $wrktype_id, $wsubtype_id, $flt_region_id, $subregion_id);
            for ($i = 1; $i <= 12; $i++) {
                $day = str_pad($i, 2, "0", STR_PAD_LEFT);
        ...
        $indexGraph = $this->load->view('supervisor_dashboard/index_report', $Rdata, true);
        $dataset = [];
        $label = [];
//        if($firsttimeload){
//            $WeekStartDate="";
...
//        }
        ...
        $histogram_count = $this->supervisor_dashboard_model->trainer_histogram_range($company_id, $trainer_id, $RightsFlag, $WRightsFlag, '', '', $wrktype_id, $wsubtype_id, $flt_region_id, $subregion_id);
        $StopFlag = false;
        if (count((array)$histogram_count) > 0) {
            ...
            $lcHtml = $this->load->view('supervisor_dashboard/histogram_report', $HRdata, true);
    ...
    public function StoreWorkshopResult() {
        ...
        foreach ($CompanySet as $value) {
            $this->supervisor_dashboard_model->SyncTrainerResult($value->company_id);
            $this->supervisor_dashboard_model->SyncWorshopResult($value->company_id);
        }
    }
    ...
    public function ajax_trainerwise_data() {
        ...
        $data['WtypeResult'] = $this->supervisor_dashboard_model->getWorkshopType($company_id, $trainer_id);
        $data['RegionResult'] = $this->supervisor_dashboard_model->getRegion($company_id, $trainer_id);
