...
class Imei_report extends MY_Controller {
    ...
    public function index() {
        ...
        $this->load->view('imei_report/index', $data);
    }
    ...
    public function DatatableRefresh() {
        ...
        if ($user_id != "") {
            ...
            $DTRenderArray = $this->Workshop_report_model->ImeiDataTable($dtWhere, $dtOrder, $dtLimit, $RightsFlag, $WRightsFlag);
            $output = array(
    ...
    public function exportReport() {//In use for Export       
        ...
        $i = 2;
        $TraineeSet = $this->Workshop_report_model->ImeiExportToExcel($dtWhere, $RightsFlag, $WRightsFlag);
        $j = 0;
