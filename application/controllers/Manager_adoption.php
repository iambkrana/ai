...
class Manager_adoption extends MY_Controller
{

    public function __construct()
    {
        parent::__construct();
        $acces_management = $this->check_rights('manager_adoption');
    ...
    public function index()
    {
        ...
        // $data['region_data'] = $this->Manager_adoption_model->get_trainee_region($data['company_id']);
        ...
        //$assessment_list= $this->Manager_adoption_model->get_assessment_list($company_id, $trainer_id, $start_date, $end_date);


        $data['report_type'] = $this->common_model->get_selected_values('assessment_report_type', 'id,description,default_selected', 'status=1');

        //----------------
        // $data['assessment_data'] = $this->Manager_adoption_model->get_assessment($data['company_id'], '', $start_date, $end_date);

        // $data['parameter_data'] = $this->Manager_adoption_model->get_parameter();
        $data['assessment'] = $this->Manager_adoption_model->get_all_assessment($manager_id);
        $this->load->view('manager_adoption/index', $data);
    }
    ...
    public function adoption_by_module($returnflag = 0)
    {
        ...
        if ($Assessment_id == '') {
            ...
            $LAssessmentDetails = $this->Manager_adoption_model->LastExpiredFiveAssessment($manager_id, $Company_id);
            ...
            if ($lastAssessmentId == "") {
                ...
                $getUserstart = $this->Manager_adoption_model->GetUserAssessmentwise($lastAssessmentId, $Company_id);
            ...
            $getUserstart = $this->Manager_adoption_model->GetUserAssessmentwise($Assessment_id,$Company_id);
        ...
        $ad_byModule = $this->load->view('manager_adoption/AdoptionByModule', $Rdata, true);
    ...
    public function get_uploaded_processed($returnflag = 0)
    {
        ...
        $ManagerDetails = $this->Manager_adoption_model->usersmangerwise($manager_id);
        ...
        else 
        {
            ...
            if ($IsCustom == '' or $IsCustom == 'Current Year') {
                ...
                $Day_type = 'current';
                $AssessmentCount = $this->Manager_adoption_model->total_video_uploaded($YearStartDate, $YearEndDate, $Day_type, $Company_id, $manager_id);
                ...
                $Day_type = "7_days";
                $AssessmentCount = $this->Manager_adoption_model->total_video_uploaded($StartStrDt, $Edate, $Day_type, $Company_id, $manager_id);
                ...
                if ($year != '' && $month != '' && $StartWeek != '') {
                    ...
                    foreach ($dateByWeek as $value) {
                        ...
                        $AssessmentCount[] = $this->Manager_adoption_model->total_video_uploaded_last_30_60($WStartDate, $WEndDate, $Company_id, $manager_id);
                ...
                $Day_type = "90_days";
                $AssessmentCount = $this->Manager_adoption_model->total_video_uploaded($StartStrDt, $EndDtdate, $Day_type, $Company_id, $manager_id);
                $begin = new DateTime($StartStrDt);
                ...
                if ($type < "15") {
                    ...
                    $Day_type = '7_days';
                    $AssessmentCount = $this->Manager_adoption_model->total_video_uploaded($SDate, $EDate, $Day_type, $Company_id, $manager_id);
        ...
        $Played_Raps_Completed = $this->load->view('manager_adoption/video_uploaded_proccessed', $Rdata, true);
    ...
    public function get_raps_played_completed($returnflag = 0)
    {
        ...
        $mapped_user = $this->Manager_adoption_model->usersmangerwise($manager_id);
        ...
        if ($len_user == 0) {
            ...
            if ($IsCustom == '' or $IsCustom == 'Current Year') {
                ...
                $report_xaxis_title = 'Yearly';
                $Day_type = 'current';
                $AssessmentCount = $this->Manager_adoption_model->RapsPlayedComplted($YearStartDate, $YearEndDate, $Day_type, $Company_id, $mapped_user_id);
                $MappedUserCount = $this->Manager_adoption_model->MappedUsers($YearStartDate, $YearEndDate, $Day_type, $Company_id, $manager_id);
                for ($i = 1; $i <= $current_month; $i++) {
                    $day = str_pad($i, 2, "0", STR_PAD_LEFT);
                    $TempDate = Date('Y-' . $day . '-01');
                ...
                $report_xaxis_title = 'Last 7 Days';
                $Day_type = "7_days";
                $AssessmentCount = $this->Manager_adoption_model->RapsPlayedComplted($StartStrDt, $Edate, $Day_type, $Company_id, $mapped_user_id);
                $MappedUserCount = $this->Manager_adoption_model->MappedUsers($StartStrDt, $Edate, $Day_type, $Company_id, $manager_id);
                ...
                if ($year != '' && $month != '' && $StartWeek != '') {
                    ...
                    foreach ($dateByWeek as $value) {
                        ...
                        $EndWeek[] = date('d', strtotime($WEndDate));
                        $weeksteddate[] = $value[0] . '-' . $value[1];
                        $AssessmentCount[] = $this->Manager_adoption_model->raps_played_completed_30_60($WStartDate, $WEndDate, $Company_id, $mapped_user_id);
                        $MappedUserCount = $this->Manager_adoption_model->raps_mapped_user_30_60($WStartDate, $WEndDate, $Company_id, $manager_id);                
                        $result = $AssessmentCount;
                ...
                $report_xaxis_title = 'Last 90 Days';
                $Day_type = "90_days";
                $AssessmentCount = $this->Manager_adoption_model->RapsPlayedComplted($StartStrDt, $EndDtdate, $Day_type, $Company_id, $mapped_user_id);
                $MappedUserCount = $this->Manager_adoption_model->MappedUsers($StartStrDt, $EndDtdate, $Day_type, $Company_id, $manager_id);
                $begin = new DateTime($StartStrDt);
                $end   = new DateTime($EndDtdate);
                ...
                if ($type < "15") {
                    ...
                    $report_xaxis_title = '3 to 15 Days';
                    $Day_type = '7_days';
                    $AssessmentCount = $this->Manager_adoption_model->RapsPlayedComplted($SDate, $EDate, $Day_type, $Company_id, $mapped_user_id);
                    $MappedUserCount = $this->Manager_adoption_model->MappedUsers($SDate, $EDate, $Day_type, $Company_id, $manager_id);
        ...
        $Rdata['completed_dataset'] = json_encode($completed_dataset, JSON_NUMERIC_CHECK);
        $Rdata['index_label'] = json_encode($index_label);
        $Played_Raps_Completed = $this->load->view('manager_adoption/PlayedCompletedGraph', $Rdata, true);
    ...
    public function total_report_sent($returnflag = 0)
    {
        ...
        $newyear = date('Y');
        $Week = $this->input->post('week', true);
        $userDetails = $this->Manager_adoption_model->usersmangerwise($manager_id);
        ...
        else 
        {
            ...
            if ($IsCustom == '' or $IsCustom == 'Current Year') {
                ...
                $report_xaxis_title = 'Yearly';
                $Day_type = 'current';
                $total_reports_sent = $this->Manager_adoption_model->total_reports_sent_manager($StartStrDt, $EndDate, $Day_type, $Company_id, $userId);
                ...
                $report_xaxis_title = 'Last 7 Days';
                $Day_type = "7_days";
                $total_reports_sent = $this->Manager_adoption_model->total_reports_sent_manager($StartStrDt, $Edate, $Day_type, $Company_id, $userId);
                $begin = new DateTime($StartStrDt);
                $end   = new DateTime($Edate);
                for ($i = $begin; $i <= $end; $i->modify('+1 day')) {
                    $day = $i->format("d");
                ...
                if ($year != '' && $month != '' && $StartWeek != '') {
                    ...
                    foreach ($dateByWeek as $value) {
                        ...
                        $EndWeek[] = date('d', strtotime($WEndDate));
                        $weeksteddate[] = $value[0] . '-' . $value[1];
                        $total_reports_sent[] = $this->Manager_adoption_model->total_reports_sent_manager_last_30_60($WStartDate, $WEndDate, $Company_id, $userId);
                ...
                $report_xaxis_title = 'Last 90 Days';
                $Day_type = "90_days";
                $total_reports_sent = $this->Manager_adoption_model->total_reports_sent_manager($StartStrDt, $EndDtdate, $Day_type, $Company_id, $userId);
                $begin = new DateTime($StartStrDt);
                $end   = new DateTime($EndDtdate);
                ...
                if ($type <= "15") {
                    ...
                    $report_xaxis_title = '3 to 15 Days';
                    $Day_type = '7_days';
                    $total_reports_sent = $this->Manager_adoption_model->total_reports_sent_manager($SDate, $EDate, $Day_type, $Company_id, $userId);
                    $begin = new DateTime($SDate);
                    $end   = new DateTime($EDate);
                    for ($i = $begin; $i <= $end; $i->modify('+1 day')) {
                        $day = $i->format("d");
            ...
            $total_reports_sent = $this->Manager_adoption_model->Month_Wise_Count_Send_manager($monthstartdate, $monthenddate, $lastmonthdate, $lastmonthenddate, $Company_id, $userId);
        ...
        $Rdata['index_label'] = json_encode($index_label);
        $total_report_sent = $this->load->view('manager_adoption/total_report_sent', $Rdata, true);
    ...
    public function total_questions_mapped($returnflag = 0)
    {
        ...
        $newyear = date('Y');
        $Week = $this->input->post('week', true);
        $AssesmentDetails = $this->Manager_adoption_model->assessmentmangerwise($manager_id);
        ...
        else 
        {
            ...
            if ($IsCustom == '' or $IsCustom == 'Current Year') {
                ...
                $report_xaxis_title = 'Yearly';
                $Day_type = 'current';
                $total_question_mapped = $this->Manager_adoption_model->total_questions_mapped($StartStrDt, $EndDate, $Day_type, $Company_id,$manager_id);
                ...
                $report_xaxis_title = 'Last 7 Days';
                $Day_type = "7_days";
                $total_question_mapped = $this->Manager_adoption_model->total_questions_mapped($StartStrDt, $Edate, $Day_type, $Company_id,$manager_id);
                $begin = new DateTime($StartStrDt);
                $end   = new DateTime($Edate);
                for ($i = $begin; $i <= $end; $i->modify('+1 day')) {
                    $day = $i->format("d");
              ...
              // Last 7 days  
                ...
                if ($year != '' && $month != '' && $StartWeek != '') {
                    ...
                    foreach ($dateByWeek as $value) {
                        ...
                        $EndWeek[] = date('d', strtotime($WEndDate));
                        $weeksteddate[] = $value[0] . '-' . $value[1];
                        $total_question_mapped[] = $this->Manager_adoption_model->total_questions_mapped_30_60($WStartDate, $WEndDate, $Company_id,$manager_id);
                ...
                $report_xaxis_title = 'Last 90 Days';
                $Day_type = "90_days";
                $total_question_mapped = $this->Manager_adoption_model->total_questions_mapped($StartStrDt, $EndDtdate, $Day_type, $Company_id,$manager_id);
                $begin = new DateTime($StartStrDt);
                $end   = new DateTime($EndDtdate);
                ...
                if ($type <= "15") {
                    ...
                    $report_xaxis_title = '3 to 15 Days';
                    $Day_type = '7_days';
                    $total_question_mapped = $this->Manager_adoption_model->total_questions_mapped($SDate, $EDate, $Day_type, $Company_id, $manager_id);
                    $begin = new DateTime($SDate);
                    $end   = new DateTime($EDate);
                    for ($i = $begin; $i <= $end; $i->modify('+1 day')) {
                        $day = $i->format("d");
            ...
            $lastmonthdate = date("Y-m-d", strtotime("first day of previous month"));
            $lastmonthenddate = date('Y-m-d', strtotime('last day of previous month'));
            $total_question_mapped = $this->Manager_adoption_model->Month_wise_count_questions($monthstartdate, $monthenddate, $lastmonthdate, $lastmonthenddate, $Company_id,$manager_id);
        ...
        $Rdata['count'] = json_encode($truefalse, JSON_NUMERIC_CHECK);
        $Rdata['index_label'] = json_encode($index_label);
        $total_question_mapped = $this->load->view('manager_adoption/total_question_mapped', $Rdata, true);
    ...
    public function get_raps_mapped_user($returnflag = 0)
    {
        ...
        if ($IsCustom == '' or $IsCustom == "Current Year") {
            ...
            $UserCount = $this->Manager_adoption_model->MappedUsers($YearStartDate, $YearEndDate, $Day_type, $Company_id,$manager_id);
            for ($i = 1; $i <= $current_month; $i++) {
                $day = str_pad($i, 2, "0", STR_PAD_LEFT);
                $TempDate = Date('Y-' . $day . '-01');
            ...
            $report_xaxis_title = 'Last 7 Days';
            $Day_type = "7_days";
            $UserCount = $this->Manager_adoption_model->MappedUsers($StartStrDt, $Edate, $Day_type, $Company_id,$manager_id);
            $begin = new DateTime($StartStrDt);
            $end   = new DateTime($Edate);
            for ($i = $begin; $i <= $end; $i->modify('+1 day')) {
                $day = $i->format("d");
            ...
            if ($year != '' && $month != '' && $StartWeek != '') {
                ...
                foreach ($dateByWeek as $value) {
                    ...
                    $EndWeek[] = date('d', strtotime($WEndDate));
                    $weeksteddate[] = $value[0] . '-' . $value[1];
                    $UserCount[] = $this->Manager_adoption_model->raps_mapped_user_30_60($WStartDate, $WEndDate, $Company_id,$manager_id);
                    $result = $UserCount;
                }
            } else {
                $result = '';
            ...
            $report_xaxis_title = 'Last 90 Days';
            $Day_type = "90_days";
            $UserCount = $this->Manager_adoption_model->MappedUsers($StartStrDt, $EndDtdate, $Day_type, $Company_id,$manager_id);
            $begin = new DateTime($StartStrDt);
            $end   = new DateTime($EndDtdate);
        ...
        // Custom Datepicker
            ...
            if ($type <= "15") {
                ...
                $Day_type = '7_days';
                $UserCount = $this->Manager_adoption_model->MappedUsers($SDate, $EDate, $Day_type, $Company_id,$manager_id);
                $begin = new DateTime($SDate);
                $end   = new DateTime($EDate);
                for ($i = $begin; $i <= $end; $i->modify('+1 day')) {
                    $day = $i->format("d");
        ...
        // Monthly Count
            ...
            $lastmonthdate = date("Y-m-d", strtotime("first day of previous month"));
            $lastmonthenddate = date('Y-m-d', strtotime('last day of previous month'));
            $total_reps_mapped_monthly = $this->Manager_adoption_model->total_users_maped($monthstartdate, $monthenddate, $lastmonthdate, $lastmonthenddate, $Company_id,$manager_id);
        ...
        $Rdata['index_dataset'] = json_encode($index_dataset, JSON_NUMERIC_CHECK);
        $Rdata['index_label'] = json_encode($index_label);
        $Raped_userGraph = $this->load->view('manager_adoption/reps_mapped_user', $Rdata, true);
    ...
    public function manager_wise_users()
    {
        ...
        $assessment_list = $this->Manager_adoption_model->assessment_wise_manager($assessment_id,$manager_id);
    ...
    public function adoption_by_reps($returnflag = 0)
    {
        ...
        else 
        {
            if($Assessment_id==''){
                $CurrentDate = date("Y-m-d h:i:s");
                $LAssessmentDetails = $this->Manager_adoption_model->LastExpiredAssessment($CurrentDate,$Company_id,$manager_id);
                $report_title = $LAssessmentDetails[0]['assessment'];
                $Assessment_id = $LAssessmentDetails[0]['id'];
                $username= $this->Manager_adoption_model->get_user_name_last($Assessment_id,$manager_id);
                $looparray = count($username);
                for ($i = 0; $i < $looparray; $i++) {
                    $users_id[] =    isset($username[$i]['user_id']) ? $username[$i]['user_id'] : 'Empty Data';
                }
                $getUserstart = $this->Manager_adoption_model->Getplayed_complted_managerwise($Assessment_id,$Company_id,$manager_id,$users_id);
                ...
                $customTitle = $this->Manager_adoption_model->GetAssessmentName($Assessment_id);
                $report_title = $customTitle[0]['assessment'];
                $username= $this->Manager_adoption_model->get_user_name($Assessment_id,$manager_id,$user_id);
                $getUserstart = $this->Manager_adoption_model->Getplayed_complted_managerwise($Assessment_id,$Company_id,$manager_id,$user_id);
                $new = count($user_id);
                for ($i = 0; $i < $new; $i++) {
                        $index_dataset[] =    isset($username[$i]['user_name']) ? $username[$i]['user_name'] : 'Empty Data';
                        $Userstarted[] =    isset($getUserstart[$i]['per_user_strated']) ? $getUserstart[$i]['per_user_strated'] : '0';
        ...
        $ad_by_Reps = $this->load->view('manager_adoption/AdoptionByReps', $Rdata, true);
