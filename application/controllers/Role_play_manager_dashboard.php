...
// $data['Total_Assessment'] = $this->role_play_manager_dashboard_model->get_Total_Assessment($Company_id, $SDate, $EDate, $region_id, $store_id, $supervisor_id, $report_type, $assessment_id1);
        ...
        $data['Total_Assessment'] = $this->role_play_manager_dashboard_model->Total_Assessment_count($Company_id, $SDate, $EDate, $region_id, $store_id, $supervisor_id, $report_type, $assessment_id1);
    ...
    public function getFilterDashboardData($returnflag = 0)
    {
        ...
        $assessment_id = $this->input->post('assessment_id1'); //Assessment Type Added by Anurag date:- 12-03-24
       
        //Assessment Type Added by Anurag date:- 12-03-24
        ...
        $region_list = array();
        $regionset = $this->role_play_manager_dashboard_model->get_region_result($Company_id, $report_by,$region_id,$StartDate,$EndDate,$assessment_id, $report_type, $supervisor_id, $assessment_type); //Assessment Type Added by Anurag date:- 12-03-24
        ...
        if (count((array)$regionset) > 0) {
			if($report_by==1){
				$Avgset = $this->role_play_manager_dashboard_model->get_region_average($Company_id, 1,$region_id,$StartDate,$EndDate,$assessment_id, $report_type, $supervisor_id, $assessment_type); //Assessment Type Added by Anurag date:- 12-03-24
				$Avgset2 = $this->role_play_manager_dashboard_model->get_region_average($Company_id, 3,$region_id,$StartDate,$EndDate,$assessment_id, $report_type, $supervisor_id, $assessment_type); //Assessment Type Added by Anurag date:- 12-03-24
			}else{
				$Avgset = $this->role_play_manager_dashboard_model->get_region_average($Company_id, 2,$region_id,$StartDate,$EndDate,$assessment_id, $report_type, $supervisor_id, $assessment_type); //Assessment Type Added by Anurag date:- 12-03-24
				$Avgset2 = $this->role_play_manager_dashboard_model->get_region_average($Company_id, 4,$region_id,$StartDate,$EndDate,$assessment_id, $report_type, $supervisor_id, $assessment_type); //Assessment Type Added by Anurag date:- 12-03-24
			}
    ...
    public function region_scoredata()
    {
        ...
        if ($data['assessment_id'] != '') {
            $this->db->select("assessment_type");
            $this->db->from("assessment_mst");
            $this->db->where("id", $data['assessment_id']);
            $assessment_type =  $this->db->get()->result_array();
            $data['assessment_type'] = $assessment_type[0]['assessment_type'];
        }
    ...
    public function regionwise_table()
    {
        ...
        $user_list = array();
        $regiondata_result = array();
        $result_data = $this->role_play_manager_dashboard_model->get_parameter_user_result_new($company_id, $region_id, $assessment_id, $report_type, $assessment_type); //Assessment Type Added by Anurag date:- 12-03-24
        $Horizontal_avg =array();
        $Vertical_avg =array();
        $Final_avg=0;
        if (count((array)$result_data) > 0) {
            $Avgset = $this->role_play_manager_dashboard_model->get_user_average($company_id, 1,$region_id,$assessment_id,$report_type, $assessment_type); //Assessment Type Added by Anurag date:- 12-03-24
            $Avgset2 = $this->role_play_manager_dashboard_model->get_user_average($company_id, 3,$region_id,$assessment_id,$report_type, $assessment_type); //Assessment Type Added by Anurag date:- 12-03-24
...
$assessment_type = $this->input->post('assessment_type', true);
        ...
        $region_list = array();
        $regiondata_result = array();
        $result_data = $this->role_play_manager_dashboard_model->get_parameter_assessment_result($company_id, $assessment_id, $report_type, $assessment_type);
        ...
        $Final_avg = 0;
        if (count((array)$result_data) > 0) {
            $Avgset = $this->role_play_manager_dashboard_model->get_pararegion_average($company_id, 1, $assessment_id, $report_type, $assessment_type);
            $Avgset2 = $this->role_play_manager_dashboard_model->get_pararegion_average($company_id, 3, $assessment_id, $report_type, $assessment_type);
            foreach ($Avgset2 as $key => $rl) {
                $Horizontal_avg[$rl->region_id] = $rl->result;
            }
            foreach ($Avgset as $key => $rl) {
