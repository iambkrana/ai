...
class Ai_process extends MY_Controller
{
    ...
    public function fetch_statistics()
    {
        ...
        // ai_dashboard statistic 1 start here 
        ...
        // ai_dashboard statistic 1 end here 


        // $box_vi_result = $this->ai_process_model->get_box_vi_statistics($_company_id,$_statistics_start_date,$_statistics_end_date);
        ...
        // statistic 2 end here

        // $box_ii_result = $this->ai_process_model->get_box_ii_statistics($_company_id, $_statistics_start_date, $_statistics_end_date);
        ...
        // statistic 3 start here

        $box_iii_result = $this->ai_process_model->get_box_iii_statistics($_company_id, $_statistics_start_date, $_statistics_end_date);
        ...
        $box_iv_result = $this->ai_process_model->get_box_iv_statistics($_company_id, $_statistics_start_date, $_statistics_end_date);
        if (isset($box_iv_result) and count((array)$box_iv_result) > 0) {
            $box_iv_statistics = $box_iv_result->total;
        }

        // statistic 6 start here 
        ...
        // $box_v_result = $this->ai_process_model->get_box_v_statistics($_company_id, $_statistics_start_date, $_statistics_end_date);
