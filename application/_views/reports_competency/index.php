...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white">
               ...
               <div class='row'>
                  <div class="col-lg-12 col-xs-12 col-sm-12">
                     <div class="portlet light bordered">
                        ...
                        <div class="portlet-body">
                           <form id="heat_map" name="heat_map" method="post" action="<?php echo base_url() . 'reports_competency/export_heatmap_data' ?>">
                              ...
                              <input id="heat_assessment_id" type="hidden" name="heat_assessment_id" value="">
   ...
   <script>
         ...
         $.ajax({
            ...
            success: function(msg) {
               if (msg != '') {
                  ...
                  $('#region_id').val(Oresult.region_id);
                  $('#heat_assessment_id').val(Oresult.assessment_id);
      ...
      function ExportToExcel(type, fn, dl) {
         ...
         var elt = document.getElementById("region_table");
      ...
      function download_png() {
         ...
         customBlockUI();
         const date = new Date();
         const screenshotTarget = document.getElementById('region_container');
