...
<div style="overflow-x:auto; width: 1366px;">
    <table id="region_table1" name="region_table1" style="width: 50%;float: right;">
        <tr>
            <td style="<?php echo get_graphcolor(75, 2) ?>" class="color-boxes"><span>Score 75% &gt;</span></td>
            <td style="<?php echo get_graphcolor(65, 2) ?>" class="color-boxes"><span>Score 74 to 65%&gt;</span></td>
            <td style="<?php echo get_graphcolor(55, 2) ?>" class="color-boxes"><span>Score 64 to 55% &gt;</span></td>
            <td style="<?php echo get_graphcolor(54, 2) ?>" class="color-boxes"><span>Score &lt; 54% &gt;</span></td>
        </tr>
    </table>
</div>
<br>

<div style="overflow-x:auto; width: 1366px;" id="region_container">
