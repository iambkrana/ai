                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="empyear" id="empyear" maxlength="250" value="<?php echo $result->employment_year; ?>" class="form-control input-sm notranslate" disabled="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="edubg" id="edubg" maxlength="250" value="<?php echo $result->education_background; ?>" class="form-control input-sm notranslate" disabled="">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select id="region_id" name="region_id" class="form-control input-sm notranslate" disabled="">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select id="designation_id" name="designation_id" class="form-control input-sm notranslate" disabled="">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="area" id="area" maxlength="50" value="<?php echo $result->area; ?>" class="form-control input-sm notranslate" disabled="">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
