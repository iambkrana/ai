                    ...
                    ?>
                            <tr>
                                ...
                                <!-- Function Updated for Assessment Type- 3 Question list by Anurag - Date:- 08-02-24 -->
                                    <button class="btn default btn-xs btn-solid" type="button" data-toggle="modal" onclick="load_questions('<?php echo $company_id; ?>','<?php echo $assessment_id; ?>','<?php echo $user_id; ?>', '<?php echo $assessment_type; ?>')">
