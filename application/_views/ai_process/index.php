...
$isatomAdmin = ($acces_management1['username'] == 'atomadmin') ? 1 : 0;
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                                                ...
                                                <div id="collapse_3_4" class="panel-collapse ">
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="row margin-top-10 ">
                                                                ...
                                                                <div class="portlet light bordered">
                                                                    ...
                                                                    <div class="portlet-body">
                                                                        <div class="tabbable-line tabbable-full-width">
                                                                            <ul class="nav nav-tabs notranslate" id="tabs"><!-- added by shital LM: 08:03:2024 -->
                                                            ...
                                                            <div class="row margin-top-10">
                                                                <div class="col-md-12" id="participants_table_reports">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="portlet-body">
                                                            <div class="tabbable-line tabbable-full-width">
                                                                <ul class="nav nav-tabs notranslate" id="tabs"><!-- added by shital LM: 08:03:2024 -->
                                                                    ...
                                                                    <?php if ($isatomAdmin == 1) { ?>
                                                                        <li>
                                                                            <a href="#restart_module" data-toggle="tab">Restart</a>
                                                                        </li>
                                                                    <?php } ?>
                                                                    <li>
                                                                ...
                                                                <div class="tab-content">
                                                                    ...
                                                                    <!-- Reset Module -->
                                                                    <?php if ($isatomAdmin == 1) { ?>
                                                                        <div class="tab-pane" id="restart_module">
                                                                            <div class="row mt-10">
                                                                                <div class="col-md-12">
                                                                                    <div class="panel-group accordion" id="accordion3">
                                                                                        <div class="panel panel-default">
                                                                                                                        ...
                                                                                                                        <div class="row">
                                                                                                                            <div class="col-md-12">
                                                                                                                                <div class="col-md-offset-10 col-md-2 text-right">
                                                                                                                                    <button type="button" class="btn blue-hoki btn-sm" onclick="DatatableRefresh_restart()">Search</button>
                                                                                            ...
                                                                                            <div class="col-lg-12">
                                                                                                <form role="form" id="frmAssessment_view" name="frmAssessment_view" method="post" action="">
                                                                                                    <div class="form-body">
                                                                                                        <div class="row ">
                                                                                                            <div class="col-md-12" id="assessment_panel_view">
                                                                                                                <table class="table  table-bordered table-hover table-checkable order-column" id="restart_table_view">
                                                                                                                    <thead>
                                                                                                                        <tr>
                                                                                                                            <!-- <th>
                                                                                                                            <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                                                            ...
                                                                                            <!-- Table -->
                                                                                            <div class="modal fade" id="LoadModalFilter-restart" role="basic" aria-hidden="true" data-width="400">
                                                                                                <div class="modal-dialog modal-lg" style="width:1024px;">
                                                                                                    <div class="modal-content">
                                                                                                        <div class="modal-body" id="modal-body">
                                                                                                            <img src="<?php echo $asset_url; ?>/assets/uploads/avatar/loading.gif" alt="" class="loading">
                                                                                    ...
                                                                                    <div class="col-md-12">
                                                                                        <div class="panel-group accordion" id="tab_region_wise">
                                                                                            <div class="panel panel-default">
                                                                                                ...
                                                                                                <div id="collapse_3_4" class="panel-collapse ">
                                                                                                    <div class="panel-body">
                                                                                                        <form id="frmReport_region" name="frmReport_region" method="post" action="<?php echo base_url() . 'ai_process/exportReport' ?>">
                                                                                    ...
                                                                                    <div class="col-md-12">
                                                                                        <div class="panel-group accordion" id="tab_manager_wise">
                                                                                            <div class="panel panel-default">
                                                                                                ...
                                                                                                <div id="collapse_3_4" class="panel-collapse ">
                                                                                                    <div class="panel-body">
                                                                                                        <form id="ManagerfrmReorts" name="ManagerfrmReorts" method="post" action="<?php echo base_url() . 'ai_process/exportReport' ?>">
                                                                                    ...
                                                                                    <div class="col-md-12">
                                                                                        <div class="panel-group accordion" id="tab_assessment_wise">
                                                                                            <div class="panel panel-default">
                                                                                                ...
                                                                                                <div id="collapse_3_4" class="panel-collapse ">
                                                                                                    <div class="panel-body">
                                                                                                        <form id="frmReortsAssessment" name="frmReortsAssessment" method="post" action="<?php echo base_url() . 'ai_process/exportReport_assessment_final_report' ?>">
                                                                                                            ...
                                                                                                            <div class="row margin-bottom-10">
                                                                                                                ...
                                                                                                                <div class="col-md-3">
                                                                                                                    <div class="form-group">
                                                                                                                        ...
                                                                                                                        <!-- Remove Multi Select Assessment -->
                                                                                                                        <select id="ass_id" name="ass_id" class="form-control input-sm select2me" onchange="get_ass_wise_data()" placeholder="Please select" style="width: 100%">
                                                                                                                            <option value="">All Assessments</option>
                                                                                                                            <?php if (isset($assessment)) {
                                                                                                                                foreach ($assessment as $adata) {
                                                                                                                            ?>
                                                                                                                                    <option value="<?= $adata->assessment_id; ?>"><?php echo $adata->assessment . ' - [' . $adata->status . ']' . ' - [' . $adata->assessment_type . ']'; ?></option>
                                                                                                                            <?php }
                                                                                                                            } ?>
                                                                                                                        </select>
                                                                                                                    </div>
    ...
    <script>
        ...
        //Added for color based on Assessment Type date:- 19-04-24
        function format_assessment_data_final(data) {
            var result = data.text;
            if (result.substr(-10) == "[Roleplay]") {
                var $opt_data = $('<option class="opt-blue">' + data.text + '</option>');
                return $opt_data;
            } else if (result.substr(-9) == "[Trinity]") {
                var $opt_data = $('<option class="opt-red">' + data.text + '</option>');
                return $opt_data;
            } else {
                return $opt_data;
        ...
        //Ended for color based on Assessment Type date:- 19-04-24
        ...
        jQuery(document).ready(function() {
            ...
            $('#ass_id').select2({
                ...
                width: '100%',
                allowClear: true,
                templateResult: format_assessment_data_final
            });
            //Ended for color based on Assessment Type date:- 19-04-24
        ...
        function DatatableRefresh_trainee() {
            ...
            table.dataTable({
                ...
                "fnServerData": function(sSource, aoData, fnCallback) {
                    $('#index_table_trainee tbody').addClass('notranslate'); //-- added by shital LM: 08:03:2024 --
                    aoData.push({
        ...
        function refreshTableColumnReg() {
            ...
            var region_id = $("#region_id").val();
            var report_type = $("#report_type_region_wise").val();
            $.ajax({
        ...
        function refreshTableColumnManager() {
            ...
            var managerid = $("#managerid").val();
            var report_type = $("#report_type_manager").val();
            $.ajax({
        ...
        function refreshTableColumnAssessment() {
            ...
            var report_type = $("#report_type_ass").val();
            $.ajax({
        ...
        function refreshTableColumn() {
            ...
            var report_type = $("#report_type_ass").val();
            $.ajax({
                url: '<?= base_url() . 'ai_process/generate_header_final_report_assessment'; ?>',
                type: 'POST',
                data: {
                    'assessment_id': assessment_id,
                    'report_type': report_type
        ...
        function AssessmentDatatableRefresh() {
            $('#report_section_assessment').show();
            // $('#report_section_manager').hide();
            var table = $('#index_table_assessment');
            table.dataTable({
                destroy: true,
                "language": {
                    "aria": {
                ...
                //"serverSide": true,
                "serverSide": false,
                "sAjaxSource": "<?php echo base_url() . 'ai_process/generate_report_assessment'; ?>",
                "fnServerData": function(sSource, aoData, fnCallback) {
                    aoData.push({
                        name: 'user_id',
                        value: $('#user_id_ass').val()
        ...
        //End Get Header for assessment by single assessment id
    </script>
</body>
