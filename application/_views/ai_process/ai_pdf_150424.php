...
<style>
    /* @font-face
    {
        ...
        src: url(base_url() .'libraries/tcpdf/fonts/SolaimanLipi_22-02-2012.ttf', 'TrueTypeUnicode', '', 96);
    } */
    .head-image {
        width: 250px;
        height: auto;
...
<div class="page-heading">
   ...
   ?>
   <?php
     //$title = 'Awarathons Sales Readiness (No Ranks)';
   ?>
    <p><?= $title ?></p>
   <?php //echo $pdf_lg; ?>
</div>
        ...
        <td>
            <table border="1" style="width:100%">
                ...
                if ($show_ranking == 1 or $show_ranking == "1") { ?>
                    ...
                    <?php foreach ($best_video_list as $bvl) { ?>
                        ...
                        <?php if($reference_video_right || $best_video_right) { ?>
                            ...
                            <?php if($reference_video_right) { ?>
                                <td style="background-color:#e4e4e4;width:<?= $width ?>;height:30px;font-size:13px;font-weight:normal;line-height:14px;text-align:center;"><a style="color: #232323;text-decoration:none;" href="<?php echo isset($bvl['refe_video_url']) ? $bvl['refe_video_url'] : ''; ?>"><?php echo isset($bvl['refe_video_url']) ? $bvl['refe_video_url'] : ''; ?></a></td>
                            <?php } if($best_video_right) { ?>
                                <td style="width:<?= $width ?>;height:30px;font-size:13px;font-weight:normal;line-height:14px;text-align:center;"><a style="color: #232323;text-decoration:none;" href="<?php echo $bvl['best_vimeo_url']; ?>"><?php echo $bvl['best_vimeo_url']; ?></a></td>
                            <?php } ?>
                            <td style="background-color:#e4e4e4;width:<?= $width ?>;height:30px;font-size:13px;font-weight:normal;line-height:14px;text-align:center;"><a style="color: #232323;text-decoration:none;" href="<?php echo $bvl['your_vimeo_url']; ?>"><?php echo $bvl['your_vimeo_url']; ?></a></td>
                        <?php }else{ ?>
                            <td style="width:10%;height:30px;font-size:13px;font-weight:normal;line-height:24px;text-align:center;"><?php echo $bvl['question_series']; ?></td>
                ...
                <?php } else { ?>
                    ...
                    <?php if($reference_video_right) { ?>
                        <td style="width:10%;background-color:#004369;color:#ffffff;height:30px;font-size:15px;font-weight:bold;line-height:24px;text-align:center;">S No.</td>
                        <td style="width:45%;background-color:#004369;color:#ffffff;height:30px;font-size:15px;font-weight:bold;line-height:24px;text-align:center;">Reference Video</td>
                    ...
                    <?php foreach ($best_video_list as $bvl) { ?>
                        ...
                        <?php if($reference_video_right) { ?>
                            <td style="width:10%;height:30px;font-size:13px;font-weight:normal;line-height:24px;text-align:center;"><?php echo $bvl['question_series']; ?></td>
                            <td style="background-color:#e4e4e4;width:45%;height:30px;font-size:13px;font-weight:normal;line-height:24px;text-align:center;"><a style="color: #232323;text-decoration:none;" href="<?php echo isset($bvl['refe_video_url']) ? $bvl['refe_video_url'] : ''; ?>"><?php echo isset($bvl['refe_video_url']) ? $bvl['refe_video_url'] : ''; ?></a></td>
                ...
                <?php if ($show_ranking == 1 or $show_ranking == "1") { ?>
                    ...
                    <?php foreach ($questions_list as $que) { ?>
                        <tr nobr="true" class="notranslate">
                            ...
                            <td style="background-color:#e4e4e4;width:12%;height:30px;font-size:13px;line-height:24px;text-align:center;"><?php echo ($que['your_score'] <= 0 and $que['failed_counter_your'] == 3) ? "Jarvis Unable To Process" : number_format($que['your_score'], 2, '.', '') . '%'; ?></td>
                ...
                <?php } else { ?>
                    ...
                    <?php foreach ($questions_list as $que) { ?>
                        <tr nobr="true" class="notranslate">
                            ...
                            <td style="background-color:#e4e4e4;width:20%;height:30px;font-size:13px;line-height:24px;text-align:center;"><?php echo ($que['your_score'] <= 0 and $que['failed_counter_your'] == 3) ? "Jarvis Unable To Process" : number_format($que['your_score'], 2, '.', '') . '%'; ?></td> <!-- KRISHNA -- CHANGE FOR FAILED VIDEO -->
                        </tr>
                    <?php } ?>
                <?php } ?>
            </table>
...
<table style="width:100%">
    ...
    <?php foreach ($partd_list as $partd) { ?>
        ...
        <tr>
            <td style="width:100%;">
                <table style="width:100%" class="notranslate">
                    <tr nobr="true">
