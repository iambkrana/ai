                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-9" style="padding:0px;">
                                                                    <span class="notranslate"><select id="filter_cmp_id" name="filter_cmp_id" class="form-control notranslate input-sm select2" placeholder="Please select" style="width: 100%">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9" style="padding:0px;">
                                                                <span class="notranslate"><select id="filter_status" name="filter_status" class="form-control input-sm select2 notranslate" placeholder="Please select" style="width: 100%">
                                                                        <option value="">All
                                                                        <option>
