                                    ...
                                    <form id="frmRole" name="frmRole" method="POST" action="<?php echo $base_url; ?>company_roles/update/<?php echo base64_encode($role_data->arid); ?>">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <span class="notranslate"><select id="company_id" name="company_id" class="notranslate form-control input-sm select2" placeholder="Please select" <?php echo ($DisabledFlag ? 'disabled' : ''); ?>>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" id="name" maxlength="50" class="notranslate form-control input-sm" value="<?php echo $role_data->rolename; ?>" autocomplete="off" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Remarks</label>
                                                    <textarea rows="4" class="form-control notranslate input-sm" name="description" placeholder=""><?php echo $role_data->description; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
