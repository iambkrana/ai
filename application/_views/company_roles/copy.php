                                        ...
                                        <form id="frmRole" name="frmRole" method="POST" action="<?php echo $base_url; ?>company_roles/update/<?php echo base64_encode($role_data->arid); ?>">    
                                            ...
                                            <div class="row">    
                                                <div class="col-md-3">       
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="name" id="name" maxlength="50" class="form-control notranslate input-sm" value="<?php echo $role_data->rolename; ?>" autocomplete="off"/>                                 
                                                    </div>
                                                </div>
                                                <div class="col-md-3">    
                                                    <div class="form-group">
                                                        <label>Status</label>
                                                        <span class="notranslate"><select id="status" name="status" class="form-control notranslate input-sm select2" placeholder="Please select" >
                                            ...
                                            <div class="row">      
                                                <div class="col-md-6">    
                                                    <div class="form-group">
                                                        <label>Remarks</label>
                                                        <textarea rows="4" class="form-control input-sm notranslate" name="description" placeholder=""><?php echo $role_data->description; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
