                                                ...
                                                <div class="row margin-bottom-10">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label class="control-label">Supervisor - [Division]&nbsp;<span class="required"> * </span> </label>
                                                            <select id="division_id" name="division_id" class="form-control input-sm select2me" style="width: 100%" onchange="getDivisionwiseData()">
                                                                <option value="">Please Select</option>
                                                                <?php foreach ($division_data as $d_data) { ?>
                                                                    <option value="<?= $d_data->id; ?>"><?php echo  $d_data->trainer_name .' - ['.$d_data->division_name.']' ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="trainer_id" name="trainer_id" class="form-control input-sm select2me" style="width: 100%" multiple=''>
                                                                <option value="">Please Select</option>
                                                                <?php foreach ($TrainerResult as $tr) { ?>
                                                                    <option value="<?= $tr->userid; ?>"><?php echo $tr->fullname; ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-1">
                                                        <div class="text-right" style="margin-top: 20px;">
                                                            <button type="button" class="btn blue-hoki btn-sm" onclick="check_division()">Search</button>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script>
        ...
        function getDivisionwiseData() {
            ...
            $.ajax({
                ...
                //async: false,
                url: "<?php echo $base_url; ?>assessment_dashboard/ajax_divisionwise_data",
                beforeSend: function() {
                    customBlockUI();
                },
                success: function(msg) {
                    if (msg != '') {
                        var Oresult = jQuery.parseJSON(msg);
                        $('#trainer_id').empty();
                        $('#trainer_id').append(Oresult['trainer_html']);
                    }
                    customunBlockUI();
                }
            });
