...
<div class='col-lg-6' id='ChartDiv' style='border:1px solid #d4d4d4;padding: 5px;'>    
    <div id='container' style="max-height:370px; overflow-y:auto; ">
        <div id='workshoptype_graph' style='min-width: 310px; height: <?php echo ($totallabel>6 ? '600px':'300px') ?> margin: 0 auto'></div>
    </div>
</div>
<script>    
    ...
    Highcharts.chart('workshoptype_graph', {
            chart: {
                type: 'bar'
            },
            title: {
            text: 'WorkshopType wise Performances',
                    'style': {
                        'fontSize': '12px',
                        'fontFamily': 'Arial'
                    }
