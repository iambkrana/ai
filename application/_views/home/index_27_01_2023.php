               ...
               <form id="FilterFrm" name="FilterFrm" method="post">
                  ...
                  <div class='row' style="display: -webkit-box; overflow-x: auto; overflow-y: none;">
                     ...
                     <div class='col-md-4' style="padding-right: 0px;">
                        ...
                        <div style="text-align:right;margin-top:1%;">
                           ...
                           <?php } else { ?>
                              <a href="<?php echo base_url() . "adoption"; ?>" style="color:red;font-weight: bold;" style="pointer-events: none">See More Reports</a>
                           <?php  } ?>
                        </div>
                        <!-- See more Report -->
                        <br>
                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-3 col-md-2 col-sm-3 col-xs-6">
                        <div class="dashboard-stat aiboxes" style="width: 102%">
                           ...
                           <?php } else { ?>
                              <a type="button" href="<?php echo base_url() . "adoption"; ?>" class="more" style="pointer-events: none"><i class="fa fa-angle-right"></i> Click Here</a>
                           <?php  } ?>
                        </div>
                     </div>
                     <div class="col-lg-3 col-md-2 col-sm-3 col-xs-6">
                        <div class="dashboard-stat aiboxes">
                           ...
                           <?php } else { ?>
                              <a type="button" href="<?php echo base_url() . "assessment_create"; ?>" class="more" style="pointer-events: none"><i class="fa fa-angle-right"></i> Click Here</a>
                           <?php  } ?>
                        </div>
                     </div>
                     <div class="col-lg-3 col-md-2 col-sm-3 col-xs-6">
                        <div class="dashboard-stat aiboxes">
                           ...
                           <?php } else { ?>
                              <a type="button" href="<?php echo base_url() . "device_users"; ?>" class="more" style="pointer-events: none"><i class="fa fa-angle-right"></i> Click Here</a>
                           <?php  } ?>
                        </div>
                     </div>
                     <div class="col-lg-3 col-md-2 col-sm-3 col-xs-6">
                        <div class="dashboard-stat aiboxes" style="width:106%">
                           ...
                           <?php } else { ?>
                              <a type="button" href="<?php echo base_url() . "ai_dashboard"; ?>" class="more" style="pointer-events: none"><i class="fa fa-angle-right"></i> Click Here</a>
                           <?php  } ?>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class='row'>
                     ...
                     <?php if ($SupperAccess || isset($SideBarDataSet['ai_dashboard'])) {  ?>
                           ...
                           <?php } else { ?>
                              <a href="<?php echo base_url() . "ai_dashboard"; ?>" style="color:red;font-weight: bold;" style="pointer-events: none">See More</a>
                           <?php  } ?>
                     </div>
                  </div>
                  <!-- Row 2 -->
