                                        ...
                                        <div class="tabbable-line tabbable-full-width">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="tab_overview">    
                                                    <form id="AssessmentForm" name="AssessmentForm" method="POST"  action="<?php echo $base_url; ?>assessment/submit" enctype="multipart/form-data">                                                         
                                                        <?php
                                                        if ($errors == "") {
                                                                   ...
                                                                   <table class="table table-bordered table-hover" id="VQADatatable" name="VQADatatable" width="100%">
                                                                       <thead>
                                                                           <tr>
                                                                                ...
                                                                                <th width="10%"><a class="btn btn-primary btn-xs btn-mini " id="btnaddpanel3"  href="<?php echo base_url() . 'assessment/add_questions/' ?>" 
