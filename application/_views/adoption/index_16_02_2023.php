...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white">
         ...
         <div class="page-content-wrapper">
            <div class="page-content">
               ...
               <form id="FilterFrm" name="FilterFrm" method="post">
                  ...
                  <!-- Adoption old grpahs commeneted 01-02-2023 by Nirmal Gajjar -->
                  <!-- Adoption By Team -->
                  ...
                  <!-- </div>
                  <br> -->
                  <!-- Adoption old grpahs commeneted 01-02-2023 by Nirmal Gajjar End -->
                  ...
                  <div class="row" style="display: -webkit-box; overflow-x: auto;">
                     ...
                     <div class='col-md-6'>
                        <div class='title-bar'>
                           <span class="caption-subject font-dark bold" style="font-family:'Catamaran'; position: absolute; top: 22px; left: 23px;">Adoption by region (Overall)
                  ...
                  <!-- End Here -->
                  <!-- By Bhautik Rana 10-01-2023 -->
                  <!-- Adoption by team (overall) "01-09-2023"  and Adoption by region (overall) "01-10-2023"  end here "Nirmal Gajjar" -->
            ...
            <form id="frmModalForm" name="frmModalForm" onsubmit="return false;">
               ...
               <div class="modal-body">
                  ...
                  <div class="row">
                     <div class="col-md-11">
                        <div class="form-group last">
                           <label>Division<span style="color:red;color: red;font-size: 23px;position: absolute;top: -4px;left: 57px;">*</span>
                              <!-- <span class="select-all">Select All</span> -->
                           </label>
                           <!-- <input id="div_check" type="checkbox" id="common_check"> -->
   ...
   <!--New graphs start here 09-01-2023 -->
            ...
            <form id="frmModalForm" name="frmModalForm" onsubmit="return false;">
               ...
               <div class="modal-body">
                  ...
                  <div class="row">
                     <div class="col-md-11">
                        <div class="form-group last">
                           <label>Manager <span style=" color:red;color: red;font-size: 23px;position: absolute;top: -4px;left: 65px;">*</span></label>
   ...
   <script>
      ...
      function get_manager_div_overall(division_set, manager_set) {
         ...
         $.ajax({
            ...
            //async: false,
            url: "<?php echo $base_url; ?>adoption/get_div_manager",
            beforeSend: function() {
               customBlockUI();
            },
            success: function(msg) {
