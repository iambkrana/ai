...
<!-- <style>
    ...
    <div id='container'>
        <div id='total_video_uploaded' style='min-width: 100%; height: 300px; background:white;text-align:center'>
            ...
            exporting: {
                ...
                csv: {
                    columnHeaderFormatter: function(item, key) {
                        if (!key) {
                            return 'Videos uploaded Month'
                        }
                        return false
                    }
                },
                filename: 'Videos uploaded ' +<?php echo $report_title ?>+ '',
                buttons: {
                    contextButton: {
                        symbol: 'download',
                        'stroke-width': 1,
