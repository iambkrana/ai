                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            ...
                            <div class="page-toolbar">
                                <a href="<?php echo $base_url?>roles/create" class="btn btn-sm btn-orange pull-right">Create New</a>&nbsp;
                            </div>
                            <?php } ?>
                        </div>
                        <div class="row mt-10">
...
<script src="<?php echo $base_url; ?>assets/global/plugins/datatables/Buttons-1.3.1/js/dataTables.buttons.min.js" type="text/javascript"></script>
        <script>
                    ...
                    buttons: {
                        ...
                        action: function(){
                            $.ajax({
                                ...
                                url: "<?php echo $base_url; ?>roles/record_actions/"+opt,
            ...
            function LoadDeleteDialog(RoleName,Id){
                $.confirm({
                    title: 'Confirm!',
                    ...
                    buttons: {
                        ...
                        action: function(){
                            $.ajax({
                                type: "POST",
                                url: "<?php echo $base_url;?>roles/remove",
                                data: {deleteid:Id},
                                success: function (response_json) {
                                    var response= JSON.parse(response_json);
                                    ShowAlret(response.message,response.alert_type);
...
//                }
                ...
                table.dataTable({
                    ...
                    "processing": true,
                    "serverSide": true,
                    "sAjaxSource": "<?php echo base_url() . 'roles/DatatableRefresh'; ?>",
