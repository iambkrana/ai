...
<div class="modal-body">
            ...
            <div class="form-body">
                <div class="row">
                    ...
                    <div class="col-md-6">    
                        <div class="form-group">
                            <label>&nbsp;</label>
                            <a href="<?php echo base_url() . 'view_trinity/trainee_samplecsv' ?>" class="form-control" style="    border: none;height:auto;" ><strong>Download Sample csv File</strong></a>
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-orange" onclick="UploadXlsTrainee();" >Confirm</button>
    </div>
