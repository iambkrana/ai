                                                                   ...
                                                                   <table class="table table-bordered table-hover" id="VQADatatable" name="VQADatatable" width="100%">
                                                                       <thead>
                                                                           <tr >
                                                                                ...
                                                                                <th width="10%"><a class="btn btn-primary btn-xs btn-mini " id="btnaddpanel3"  href="<?php echo base_url() . 'view_trinity/add_questions/'.base64_encode($result->id); ?>" 
                                                                    data-target="#LoadModalFilter" data-toggle="modal"><i class="fa fa-plus"></i>&nbsp;</a></th>               <!-- DARSHIL - removed assessment/add_questions and added view_trinity/add_questions in href -->                                                                
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr id="Row-<?php echo $key; ?>">
                                                                                ...
                                                                                <td>
                                                                                    <a class="btn btn-success btn-sm" id="btnaddpanel3"  href="<?php echo ($lockFlag ? 'javascript:void(0);' : base_url() . 'view_trinity/edit_questions/'.$key); ?>"
                                                                                    <?php echo($lockFlag ? 'disabled':'data-target="#LoadModalFilter" data-toggle="modal"')?>><i class="fa fa-pencil"></i> </a>      <!-- DARSHIL - removed assessment and added view_trinity from href -->                                                              
                                                        ...
                                                        <div class="form-body">
                                                            <div class="row margin-bottom-10">      
                                                                <div class="col-md-12 text-right">                                                                     
                                                                    ...
                                                                    <a class="btn btn-orange btn-sm" id="btnaddpanel3"  href="<?php echo base_url() . 'view_trinity/importTrainee/'.base64_encode($result->id); ?>" 
                                                                    data-target="#LoadModalFilter" data-toggle="modal"><i class="fa fa-file-excel-o"></i>&nbsp;Import </a>  <!-- DARSHIL - removed assessment and added view_trinity from href -->
                                                                    &nbsp;

                                                                    <a class="btn btn-orange btn-sm" id="btnaddpanel3"  href="<?php echo base_url() . 'view_trinity/addParticipant/'.base64_encode($result->id); ?>" 
                                                                    data-target="#LoadModalFilter" data-toggle="modal"><i class="fa fa-plus"></i>&nbsp;Add Participant User </a>     <!-- DARSHIL - removed assessment and added view_trinity from href -->                                                               
                                                                </div>
                                                            </div>
                                                            <div class="row ">
                                                        ...
                                                        <div class="form-body">
                                                            <div class="row margin-bottom-10"> 
                                                                ...
                                                                <div class="col-md-10 text-right">
                                                                    ...
                                                                    <a class="btn btn-orange btn-sm" id="btnaddpanel3"  href="<?php echo base_url() . 'view_trinity/importManager/'.base64_encode($result->id); ?>" 
                                                                    data-target="#LoadModalFilter" data-toggle="modal"><i class="fa fa-file-excel-o"></i>&nbsp;Import </a>      <!-- DARSHIL - removed assessment and added view_trinity from href -->
                                                                    &nbsp;

                                                                    <a class="btn btn-orange btn-sm" id="btnaddpanel3"  href="<?php echo base_url() . 'view_trinity/addManagers/'.base64_encode($result->id); ?>" 
                                                                    data-target="#LoadModalFilter" data-toggle="modal"><i class="fa fa-plus"></i>&nbsp;Add Manager </a>          <!-- DARSHIL - removed assessment and added view_trinity from href -->                                                          
                                                                </div>
                                                            </div>
                                                            <div class="row ">
                                                                <div class="col-md-12" id="assessment_panel" >
                                                        ...
                                                        <div class="form-body">
                                                            <div class="row margin-bottom-10">   
                                                                ...
                                                                <div class="col-md-9 text-right">
                                                                    ...
                                                                    <a class="btn btn-orange btn-sm" id="btnaddpanel3"  href="<?php echo base_url() . 'view_trinity/importSupervisor/'.base64_encode($result->id); ?>" 
                                                                    data-target="#LoadModalFilter" data-toggle="modal"><i class="fa fa-file-excel-o"></i>&nbsp;Import </a>      <!-- DARSHIL - removed assessment and added view_trinity from href -->
                                                                    &nbsp;

                                                                    <a class="btn btn-orange btn-sm" id="btnaddpanel3"  href="<?php echo base_url() . 'view_trinity/addSupervisors/'.base64_encode($result->id); ?>" 
                                                                    data-target="#LoadModalFilter" data-toggle="modal"><i class="fa fa-plus"></i>&nbsp;Add Supervisor </a>      <!-- DARSHIL - removed assessment and added view_trinity from href -->                                                                 
                                                                </div>
                                                            </div>
                                                            <div class="row ">
                                                                <div class="col-md-12" id="assessment_panel" >
                                                ...
                                                <div class="tab-pane" id="tab_user_mapping">
                                                    <form role="form" id="UserMappingForm" name="UserMappingForm">
                                                        <div class="form-body">
                                                            <div class="row margin-bottom-10"> 
                                                                <div class="col-md-12 text-right">
                                                                    <a class="btn btn-orange btn-sm" id="btnaddpanel3"  href="<?php echo base_url() . 'view_trinity/addUserManagers/'.base64_encode($result->id); ?>" 
                                                                    data-target="#LoadModalFilter" data-toggle="modal"><i class="fa fa-plus"></i>&nbsp;Add Assessor </a>      <!-- DARSHIL - removed assessment and added view_trinity from href -->                                                              
                                                                </div>
                                                            </div>
                                                            <div class="row ">
                                                                <div class="col-md-12" id="assessment_panel" >
