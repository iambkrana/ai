                                                            ...
                                                            <div class="row">  
                                                               <div class="col-md-12">
                                                                   <table class="table table-bordered table-hover" id="VQADatatable" name="VQADatatable" width="100%">
                                                                    ...
                                                                    data-target="#LoadModalFilter" data-toggle="modal"><i class="fa fa-plus"></i>&nbsp;</a></th>      DARSHIL COMMENTED AND ADDED BELOW      -->
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr id="Row-<?php echo $key; ?>">
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    data-target="#LoadModalFilter" data-toggle="modal"><i class="fa fa-pencil"></i> </a>        DARSHIL COMMENTED AND ADDED BELOW      -->
                                                                                    <a class="btn btn-success btn-sm" id="btnaddpanel3"  href="<?php echo base_url() . 'view_trinity/edit_questions/'.$key; ?>" 
