<div class="modal-header">
    ...
    <h4 class="modal-title">Import Supervisor</h4>
...
<div class="modal-body">
            ...
            <div class="form-body">
                <div class="row">
                    ...
                    <div class="col-md-6">    
                        <div class="form-group">
                            <label>&nbsp;</label>
                            <a href="<?php echo base_url() . 'view_trinity/supervisor_samplecsv' ?>" class="form-control" style="    border: none;height:auto;" ><strong>Download Sample csv File</strong></a>
                            <!-- DARSHIL - removed assessment and added view_trinity from href -->
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-orange" onclick="UploadXlsSupervisor();" >Confirm</button>
    </div>
