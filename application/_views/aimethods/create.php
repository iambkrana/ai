...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="row">      
                                                <div class="col-md-12 text-right">  
                                                    <button type="button" id="aimethods-submit" name="aimethods-submit" data-loading-text="Please wait..." class="btn btn-orange mt-ladda-btn ladda-button mt-progress-demo" data-style="expand-left" onclick="save_aimethods();">
        ...
        function save_aimethods() {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>aimethods/submit',
