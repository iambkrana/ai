...
?>
    ...
    <div id='container'>
        <div id='AdoptionByTeam' style='min-width: 100%; height: 350px; background:white;'>
...
<?php } else { ?>
    ...
    <div id='container'>
        ...
        <!-- <div class="page">Page: <span id="pager"></span></div> -->
    </div>
    <?php
    ...
    <script>
        ...
        function AdoptionGraph(adoption_page) {
            ...
            for (var elem in teamarrSeries) {
                ...
                for (var i = 0; i < numDifferentElements; i++) {
                    ...
                    trainerName.push(trainer_name[intStartElement + i]);
                    ...
                    tooltip: {
                        formatter: function() {
                            if (this.series.name == 'Start Users') {
                                ...
                                usercnt = completed[this.point.index];
                            }
        ...
        $(function() {
            ...
            function Adoption_initialise_Pager() {
                var numPages = Math.ceil(trainer_name.length / 5);
                var maangerNames_len = trainer_name.length;
