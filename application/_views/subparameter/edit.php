...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                                        ...
                                        <div class="tab-content">
															...
															<div class="form-group">
																...
																<select name="parameter_id" id="parameter_id" class="form-control input-sm select2">
																	...
																	<?php foreach ($parameter_result as $param) { ?>
																		<option value="<?php echo $param->id ?>" <?php ($param->id == $result->parameter_id)?'selected':'';?> ><?php echo $param->description ?></option>
																	<?php } ?>
																</select>
															</div>
														</div>                                                    
														...
														<div class="col-md-4">
															<div class="form-group">
																<label class="mt-checkbox mt-checkbox-outline" for="has_sentences_keyword"> Allow to map Sentences / Keyword?
																	<input id="has_sentences_keyword" name="has_sentences_keyword" type="checkbox" value="1" <?php echo ($result->has_sentences_keyword==1) ? 'checked' : '';?>><span></span>
																</label>
															</div>
														</div>
													</div>
                                            ...
                                            <div class="row">      
                                                <div class="col-md-12 text-right">  
                                                    <button type="button" id="subparameter-submit" name="subparameter-submit" data-loading-text="Please wait..." class="btn btn-orange mt-ladda-btn ladda-button mt-progress-demo" data-style="expand-left" onclick="update_parameter();">
        ...
        function update_parameter() {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>subparameter/update/<?php echo base64_encode($result->id) ?>',
