...
?>
    ...
    <div id='container'>
        <div id='assessment_index_start' style='min-width: 100%; height: 300px; background:white;text-align:center'>
                ...
                exporting: {
                    ...
                    csv: {
                        columnHeaderFormatter: function(item, key) {
                            if (!key) {
                                return 'Module Started Month'
                            }
                            return false
                        }
                    },
                    filename: 'Module Started ' + <?php echo $report_title ?> + '',
                    buttons: {
                        contextButton: {
                            symbol: 'download',
                            'stroke-width': 1,
