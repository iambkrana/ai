                            ...
                            <div class="col-md-8 page-breadcrumb pull-right">
                                <div class="row">
                                 ...
                                 <?php } ?>                                                    
                                    <div class="col-md-7 ">
                                        <div class="form-group">
                                            <label class="control-label col-md-4" >Assessment Date&nbsp;<span class="required"> * </span></label>
                                            <div class="col-md-8" style="padding:0px;">
...
<!--                                    <div class="portlet-title potrait-title-mar">
                                    ...
                                    <div class="portlet-body">                                                                                                                        
                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-3 col-sm-6 col-xs-12" style="padding: 0px 5px 5px 5px;">
                                                        <div class="dashboard-stat">
                                                            <div class="display">
                                                                <div class="number">
                                                                    <h3 class="font-orange-sharp">
                                                                        <span data-counter="counterup" id="total_awarathon" data-value="0">0</span>
                                                                    </h3>
                                                                    <small>Awarathon Minutes</small>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-4" style="padding: 0px 5px 5px 5px;" id="minute_performance">
                        ...
                        <div class="row mt-10">
                            <div class="col-lg-12 col-xs-12 col-sm-12">
                                <div class="portlet light bordered" >
                                        ...
                                        <div class="portlet-body">                                                                                                                        
                                        <div class="clearfix"></div>
                                            <form id="frmReorts" name="frmReorts" method="post" action="<?php echo base_url() . 'client_minute_report/exportReport' ?>">
...
//                setMinuteData();
            ...
            function getCompanywiseData(){
                ...
                $.ajax({
                    ...
                    //async: false,
                    url: "<?php echo $base_url; ?>client_minute_report/ajax_companywise_data",
                    beforeSend: function () {
                        customBlockUI();
                    },
                    success: function (msg) {
                        if (msg != '') {
                            ...
                            $('#assessmin_id').empty();
                            $('#assessmin_id').append(Oresult['MinuteData']);
                            setMinuteData();
                        }
                        customunBlockUI();
                    }
...
//                }
                $.ajax({
                    ...
                    //async: false,
                    url: "<?php echo base_url() ?>client_minute_report/get_minute_data",
                    beforeSend: function () {
                        customBlockUI();
                    },
                    success: function (data) {
                        if (data != '') {
                            ...
                            $('#total_awarathon').attr('data-value', json['awarathon_minute']);
                            $('#total_awarathon').counterUp();
...
//                      {'width': '30px','orderable': true,'searchable': true,'targets': [0],"visible":false},
			{'className': 'dt-head-left dt-body-left','width': '200px','orderable': true,'searchable': true,'targets': [0]},
                    ...
                    "processing": true,
                    "serverSide": true,
                    "sAjaxSource": "<?php echo base_url() . 'client_minute_report/DatatableRefresh/'; ?>",
                    ...
                    "initComplete": function(settings, json) {
                        ...
                        $('thead > tr> th:nth-child(4)').css({ 'min-width': '50px', 'max-width': '100px' });
                    }
                });
            }
