                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <div id="responsive-modal" class="modal dont-fade" data-keyboard="false" data-backdrop="static" role="dialog" aria-hidden="true"  data-width="760">
                                                    ...
                                                    <div class="row">    
                                                        <div class="col-md-9">       
                                                            <div class="form-group">
                                                                <label class="">Questions Type<span class="required"> * </span></label>
                ...
                frmModalForm.validate({
                    ...
                    rules: {
                        description: {
                            required: true,
                            remote: {
                                url: "<?php echo base_url();?>index.php/type/validate",
                                type: "post",
                                data: {
                                    id: function () {
                                        return $("#edit_id").val();
...
//                    },
                    ...
                    submitHandler: function (form) {
                        ...
                        $.post('<?php echo base_url();?>index.php/type/submit', $("#frmModalForm").serialize(), function (data) {
            ...
            function LoadEditModal(edit_id){
                ...
                $.ajax({
                    ...
                    url: "<?php echo $base_url; ?>type/edit",
                    ...
                    buttons: {
                        ...
                        action: function(){
                            $.ajax({
                                ...
                                url: "<?php echo $base_url; ?>type/record_actions/"+opt,
                                success: function (response_json) {
                                    var response= JSON.parse(response_json);
                                    ShowAlret(response.message,response.alert_type);
                                    DatatableRefresh();
                ...
                if (Check > 0){
                    if( opt == 1 ){
                       LoadConfirmDialog("Confirm Active Status ?",opt);  
                        ...
                        LoadConfirmDialog("Delete Selected Questions Type(s) ?",opt);
                    }   
                }else{
            ...
            function LoadDeleteDialog(Description,Id){
                $.confirm({
                    title: 'Confirm!',
                    content: " Are you sure you want to delete questions type '"+Description+"' ? ",
                    buttons: {
                        confirm:{
                        text: 'Confirm',
                        btnClass: 'btn-orange',
                        ...
                        action: function(){
                            $.ajax({
                                type: "POST",
                                url: "<?php echo $base_url;?>type/remove",
                                data: {deleteid:Id},
                                success: function (response_json) {
                                    var response= JSON.parse(response_json);
                                    ShowAlret(response.message,response.alert_type);
...
//                }
                ...
                table.dataTable({
                    ...
                    "processing": true,
                    "serverSide": true,
                    "sAjaxSource": "<?php echo base_url() . 'type/DatatableRefresh'; ?>",
