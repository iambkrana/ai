                        ...
                        <div class="row mt-10">
                            <div class="col-md-12">                                
                                <div class="portlet light bordered">
                                    <form id="frmReorts" name="frmReorts" method="post" action="<?php echo base_url() . 'consolidated_reports/exportReport' ?>">
                                    <div class="portlet-title">
                                        ...
                                        <div class="actions">
                                            <div class="btn-group pull-right">
                                                ...
                                                <?php echo ($acces_management->allow_print ? '' :
                                                        'javascript:void(alert(\'you have no rights to Add,Contact to Administrator!!!\'))');
                                                ?>"
...
//                }
                ...
                table.dataTable({
                    ...
                    "columnDefs": [                        
                        ...
                        {'width': '230px','orderable': true,'searchable': true,'targets': [1]},
                        {'width': '250px','orderable': false,'searchable': false,'targets': [2], "visible": <?php echo ($Company_id == "" ? 'true' : 'false'); ?>},
                        {'width': '250px','orderable': true,'searchable': true,'targets': [3]}, 
                        {'width': '80px','orderable': true,'searchable': true,'targets': [4]}, 
                        {'width': '120px','orderable': false,'searchable': true,'targets': [5]}, 
                        {'width': '130px','orderable': false,'searchable': false,'targets': [6]}, 
                        {'width': '130px','orderable': false,'searchable': false,'targets': [7]}, 
                        {'width': '130px','orderable': false,'searchable': false,'targets': [8]},
                        {'width': '130px','orderable': false,'searchable': false,'targets': [9]},
                        {'width': '130px','orderable': false,'searchable': false,'targets': [10]},
                        {'width': '130px','orderable': false,'searchable': false,'targets': [1]},
                        {'width': '130px','orderable': false,'searchable': false,'targets': [12]},
                        {'width': '130px','orderable': false,'searchable': false,'targets': [13]},
                        {'width': '130px','orderable': false,'searchable': false,'targets': [14]},
                        {'width': '130px','orderable': false,'searchable': false,'targets': [15]},
                        {'width': '130px','orderable': false,'searchable': false,'targets': [16]},
                    ],
                    "order": [
                        [1, "desc"]
                    ],
                    "processing": true,
                    "serverSide": true,
                    "sAjaxSource": "<?php echo base_url() . 'consolidated_reports/DatatableRefresh/'; ?>",
    ...
    function getCompanywiseData(){
                $.ajax({
                    ...
                    async: false,
                    url: "<?php echo $base_url;?>consolidated_reports/ajax_companywise_data",
        ...
        function getSessionwiseData(){
            $.ajax({
                ...
                async: false,
                url: "<?php echo $base_url;?>consolidated_reports/ajax_sessionswise_data",
                success: function (msg) {                        
                    if (msg != '') {
                        var Oresult = jQuery.parseJSON(msg);
        ...
        function getTopicwiseData(){
            $.ajax({
                ...
                async: false,
                url: "<?php echo $base_url;?>consolidated_reports/ajax_topicwise_data",
                success: function (msg) {                        
                    if (msg != '') {
                        var Oresult = jQuery.parseJSON(msg);
