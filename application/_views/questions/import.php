                                                            ...
                                                            <div class="col-md-6">       
                                                                <div class="form-group">
                                                                    ...
                                                                    <select id="company_id" name="company_id" class="form-control input-sm select2" placeholder="Please select" style="width:100%" onchange="getComapnywiseTopic();">
                                                                        ...
                                                                        <?php
                                                                        if (count($CompanySet) > 0) {
                                                                            foreach ($CompanySet as $cmp) {
                                                                                ?>
...
<!--                                                                    <span class="text-muted">(only .csv allowed)</span>-->
                                                        ...
                                                        <div class="col-md-3">    
                                                            <div class="form-group">
                                                                <label>&nbsp;</label>
                                                                <a class="form-control" style="border: none;height:auto;" href="javascript:void(0);" onclick="download_sample();" ><strong>Download Sample File</strong></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="panel panel-success">
                                                        ...
                                                        <div class="panel-body">
                                                            <ul>
                                                                ...
                                                                <li>Correct answer should be(A/B/C/D).</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>                                                           
        ...
        function download_sample(){
            ...
            if(language_id==null || language_id==1){
                window.location.href ='<?php echo base_url(); ?>questions/sample_csv/';
            }else{
                window.location.href ='<?php echo base_url(); ?>questions/sample_xls/';
            }
        }
    function Confirm_imports() {
        ...
        $.confirm({
            ...
            content: 'Are you sure you want to import in <strong>'+$("#language_id option:selected").text()+' Language </strong>?',
            buttons: {
                confirm: {
                    text: 'Confirm',
                    btnClass: 'btn-orange',
    ...
    function SubmitData() {
            ...
            $.ajax({
                ...
                processData: false,
                type: "POST",
                url: '<?php echo site_url("questions/confirm_xls_csv"); ?>',
                data: form_data,
