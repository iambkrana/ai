                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3">    
                                                                <div class="form-group">
                                                                    ...
                                                                    <select id="subtopic_id" disabled="" name="subtopic_id" class="form-control input-sm select2me" placeholder="Please select" style="width:100%" >
                                                            ...
                                                            <div class="col-md-3">    
                                                                <div class="form-group">
                                                                    ...
                                                                    <select id="language_id" name="language_id" disabled="" class="form-control input-sm select2me" placeholder="Please select" style="width:100%" >
                                                                        <?php
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">    
                                                                <div class="form-group">
                                                                    ...
                                                                    <select id="correct_answer" disabled="" name="correct_answer" class="form-control input-sm select2me" placeholder="Please select" onchange="CheckValidAnswer();" >
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-2">    
                                                                <div class="form-group">
                                                                    ...
                                                                    <select id="status" name="status" class="form-control input-sm select2me" disabled="" placeholder="Please select" >
