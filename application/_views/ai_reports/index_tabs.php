                                                                                    ...
                                                                                    <div class="row margin-bottom-10">
                                                                                        ...
                                                                                        <div class="col-md-3">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <select id="user_id" name="user_id" class="form-control input-sm select2me" placeholder="Please select" multiple="" style="width: 100%">
                                                                                                    <?php
                                                                                                    if (isset($user_details)) {
                                                                                                        foreach ($user_details as $Rdata) {
                                                                                                            ?>
                                                                                                                    <option value="<?= $Rdata->user_id; ?>"><?php echo '['. $Rdata->user_id .'] - '. $Rdata->user_name; ?></option>
                                                                                                            <?php
                                                                                                        }
                                                                                                    }
                                                                                                    ?>
                                                                            ...
                                                                            <div class="panel-body">
                                                                                ...
                                                                                <div class="row margin-bottom-10">
                                                                                        ...
                                                                                        <div class="col-md-3">
                                                                                            <div class="form-group">
                                                                                                <label class="control-label">Reps &nbsp;</label>
                                                                                                <select id="user_id_region_wise" name="user_id_region_wise" class="form-control input-sm select2me" multiple="" placeholder="Please select" style="width: 100%">
                                                            ...
                                                            <div class="col-md-12" id="region_section">
                                                                <div class="portlet light bordered">
                                                                    <div class="portlet-title">
                                                                        ...
                                                                        <?php } ?>
                                                                        <div class="clearfix margin-top-20"></div>
                                                                        <div class="portlet-body" id="region_table"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                            ...
                                                                            <div class="panel-body">
                                                                                ...
                                                                                <div class="row margin-bottom-10">
                                                                                        ...
                                                                                        <div class="col-md-3">
                                                                                            <div class="form-group">
                                                                                                <label class="control-label">Reps &nbsp;</label>
                                                                                                <select id="user_id_manager" name="user_id_manager" class="form-control input-sm select2me" multiple="" placeholder="Please select" style="width: 100%">
                                                                            ...
                                                                            <div class="panel-body">
                                                                                ...
                                                                                <div class="row margin-bottom-10">
                                                                                        ...
                                                                                        <div class="col-md-3">
                                                                                            <div class="form-group">
                                                                                                <label class="control-label">Reps &nbsp;</label>
                                                                                                <select id="user_id_ass" name="user_id_ass" class="form-control input-sm select2me" multiple="" placeholder="Please select" style="width: 100%">
