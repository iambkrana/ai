        ...
        <div class="kt-section">
            ...
            <div class="kt-section__content">
                <div class="table-responsive">
                    <!-- <form id="formReportparticipate" name="formReportparticipate" method="post" action="<?php echo base_url() . 'ai_reports/export_participate' ?>"> -->
                    <form id="formReportparticipate" name="formReportparticipate" method="post" action="<?php echo $assessment_type == 3  ? base_url() .'ai_reports/export_trinity_dump' : base_url() . 'ai_reports/export_participate'  ?>">
                    ...
                    <table class="table table-bordered" id="aiprocess_tb">
                        <thead>
                            ...
                            <?php if($ismasterAdmin){ ?><th style="width:8%">Assessment Id</th> <?php } ?>
                                ...
                                <th style="width:8%">Vimeo<br>Uploaded <br>Date</th>
                                <th style="width:8%">Vimeo<br /> Process<br> Date</th>
                                <th style="width:8%">Vimeo<br />Difference</th> -->
                        ...
                        <tbody>
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <!-- <td><?php //echo $pdata->added_date;?></td> 
                                            <td><?php //echo $pdata->uploaded_dt; ?></td>
                                            <td><?php //echo $pdata->process_dt; ?></td>
                                            <td><?php //echo '('.$pdata->datediff.') days - ('.$pdata->time_diff.') Time'; ?></td> -->
                                            ...
                                            <td>
                                                <form method="post" name="export_trinity" id="export_trinity" action="<?php echo base_url() . 'ai_reports/export_trinity_dump'; ?>">
                                                    <input type="hidden" name='user_id' value='<?php echo $pdata->user_id; ?>'>
                                                    <input type="hidden" name='assessment_id' value='<?php echo $assessment_id; ?>'>
