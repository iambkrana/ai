...
<html lang="en">
                                    ...
                                    <div class="portlet-body">
                                        <div class="tabbable-line tabbable-full-width">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <form id="frmUsers" name="frmUsers" method="POST"  action="<?php echo $base_url;?>users/update/<?php echo base64_encode($result->userid);?>">    
                                                    <div class="row">    
                                                        <div class="col-md-3">       
                                                            <div class="form-group">
                                                                <label class="">Login ID<span class="required"> * </span></label>
                                                                <input type="text" name="loginid" id="loginid" maxlength="20" class="form-control input-sm" value="<?php echo $result->username; ?>">                                 
                ...
                $('#roleid').select2({
                    ...
                    initSelection: function(element, callback) {
                        return $.getJSON("<?php echo base_url();?>index.php/users/ajax_populate_roles?id=<?php echo $result->role; ?>", null, function(data) {
                            //var data = {id: "<?php //echo $result->role; ?>", text: "<?php //echo $result->rolename; ?>"};
                            return callback(data);
                        });
                    }
                });
                $("#roleid").select2("trigger", "select", { 
                    data: { id: "<?php echo $result->role; ?>",text:"<?php echo $result->rolename; ?>" } 
                }); 
    ...
    return value.indexOf(" ") < 0 && value != "";
                ...
                $.ajax({
                    type: "POST",
                    data: {email_id:value,user:<?php echo $result->userid; ?>},
            ...
            jQuery.validator.addMethod("LoginId_Check", function(value, element){
                ...
                $.ajax({
                    type: "POST",
                    data: {login_id:value,user:<?php echo $result->userid; ?>},
            ...
            jQuery.validator.addMethod("first_lastCheck", function(value, element){                  
                ...
                $.ajax({
                    type: "POST",
                    data: {firstname:$('#first_name').val(),lastname:$('#last_name').val(),user:<?php echo $result->userid; ?>},
