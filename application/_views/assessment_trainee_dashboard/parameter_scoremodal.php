...
<script>
    ...
    function assessment_usercount(assessment_id) {
         var assess_id=assessment_id;
            ...
            $.ajax({
                url: base_url + "assessment_trainee_dashboard/assessment_usercount",
                type: 'POST',
...
//                      {'width': '30px','orderable': true,'searchable': true,'targets': [0],"visible":false},
			{'className': 'dt-head-left dt-body-left','width': '130px','orderable': true,'searchable': true,'targets': [0]},
                        {'className': 'dt-head-left dt-body-left','width': '100px','orderable': false,'searchable': false,'targets': [1]}
                    ],
                    
                    "processing": true,
                    "serverSide": true,
                    "sAjaxSource": "<?php echo base_url() . 'assessment_trainee_dashboard/QuestionScoreDatatable/'; ?>",
