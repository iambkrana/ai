                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    ...
                                    <span>Workshop-wise Report</span>
                                </li>
                            </ul>
                        </div>
                        <div class="row mt-10">
                        ...
                        <div class="row mt-10">
                            <div class="col-md-12">
                                <div class="portlet light bordered">
                                    <form id="frmReorts" name="frmReorts" method="post" action="<?php echo base_url() . 'workshop_wise_report/exportReport' ?>">
...
//                      {'width': '30px','orderable': true,'searchable': true,'targets': [0],"visible":false},
                    ...
                    "processing": true,
                    "serverSide": true,
                    "sAjaxSource": "<?php echo base_url() . 'workshop_wise_report/DatatableRefresh/'; ?>",
