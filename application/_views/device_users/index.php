        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <form id="deviceUsers" name="deviceUsers"  action="<?php echo base_url() . 'device_users/export_trainee/' ?>" method="post">
                                            ...
                                            <div class="btn-group pull-right">
                                                ...
                                                <a href="<?php echo site_url("device_users/import"); ?>"
                                                    class="btn orange btn-sm btn-outline" style="margin-right: 10px;"><i
                                                        ...
                                                        <a href="<?php echo site_url("device_users/import_update"); ?>"
                                                    class="btn orange btn-sm btn-outline" style="margin-right: 10px;"><i
                                                        class="fa fa-file-excel-o"></i> Import - UPDATE</a>
