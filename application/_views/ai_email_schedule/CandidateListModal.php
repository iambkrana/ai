<div class="modal-header">
    ...
    <div style="float:right;font-size:11px;font-weight:400;">
		<span style="height: 15px;width: 15px;background: #ff2292;padding: 9px;color: #ffffff;">GRP</span> Generate Report Pending 
		<span style="height: 15px;width: 15px;background: #ff5722;padding: 9px;color: #ffffff;">SP</span> Schedule Pending 
		<span style="height: 15px;width: 15px;background: #4caf50;padding: 9px;color: #ffffff;">RP</span> Rating Pending
    </div>
</div>
