<div id='container'>
        <!-- <div id='total_device_user' style='min-width: 100%; height: 300px; margin: 0 auto'></div> -->
        <div id='total_device_user' style='min-width: 100%; height: 300px;'></div>
        <!-- <div id='assessment_total_report' style='width: 519.6px; height:290px; position: absolute;top: 49px;left: 16px;'></div> -->
        <!-- <div id='total_device_user' style='width: 100%; height:290px; position: absolute;top: 49px;left: 1px;'></div> -->
...
<script>
    ...
    $(document).ready(function () {   
        Highcharts.chart('total_device_user', {
            chart: {
                 type: 'area',
