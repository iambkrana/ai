...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white">
                  ...
                  <div class="row">
                     <div class="col-md-11">
                        <div class="form-group last">
                           ...
                           <select id="assessment_id" name="assessment_id" class="form-control input-sm select2me" placeholder="Please select">
                              <option value="">Select</option>
                              <?php
                              if (isset($assessment)) {
                                 foreach ($assessment as $adata) {
                  ...
                  <div class="row">
                     <div class="col-md-11">
                        <div class="form-group last">
                           ...
                           <select id="am_id" name="am_id" class="form-control input-sm select2me" placeholder="Please select">
                              <option value="">Select</option>
                              <?php
                              if (isset($assessment)) {
                                 foreach ($assessment as $adata) {
   ...
   <script>
      ...
      function get_all_division(division_set) {
