...
<!-- <style>
    ...
    <div id='container'>
        <div id='total_video_processed' style='min-width: 100%; height: 300px; background:white;text-align:center'>
...
<?php }  else{ ?>
<div id='container'>
    <div id='total_video_processed' style='min-width: 100%; height: 300px;'></div>
    <div class="clearfix"></div>
</div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        Highcharts.chart('total_video_processed', {
            chart: {
                type: 'area',
                marginTop: 95,
                spacingBottom: 25,
            ...
            exporting: {
                ...
                csv: {
                    columnHeaderFormatter: function(item, key) {
                        if (!key) {
                            return 'Video Processed Month'
                        }
                        return false
                    }
                },
                filename: 'Video Processed ' +<?php echo $report_title ?>+ '',
                buttons: {
                    contextButton: {
