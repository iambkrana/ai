...
?>
    <div id='container'>
        <div id='AdoptionByDivision' style='min-width: 100%; height: 350px; background:white;text-align:center'>
...
<?php } else { ?>
    <div id='container'>
        <div id='AdoptionByDivision' style='min-width: 100%; height: 350px;'></div>
        <div class="clearfix"></div>
    </div>
    <?php
        ...
        $(document).ready(function() {
            ...
            Highcharts.chart('AdoptionByDivision', {
                ...
                exporting: {
                    ...
                    filename: 'Adoption by Division ' + ReportTitle + '',
                    buttons: {
                        contextButton: {
                            symbol: 'download',
                            symbolStroke: "#004369",
