                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <span>Advertisement Listing</span>
                                </li>
                            </ul>
                            <?php if($acces_management->allow_add){ ?>
                            <div class="page-toolbar">
                                <a href="<?php echo $base_url ?>advertisement/create" class="btn btn-sm btn-orange pull-right">Create New</a>&nbsp;
                            </div>
                            <?php } ?>
                        </div>
                        <div class="row mt-10">
...
<script>
                    ...
                    confirm: {
                        ...
                        action: function () {
                            $.ajax({
                                ...
                                url: "<?php echo $base_url; ?>advertisement/record_actions/" + opt,
                                beforeSend: function () {
                                    customBlockUI();
                                },
        ...
        function ValidCheckbox(opt) {
            ...
            if (Check > 0) {
                if (opt == 1) {
                    ...
                    LoadConfirmDialog("Delete Selected Advertisement(s) ?", opt);
                }
            } else {
        ...
        function LoadDeleteDialog(Id) {
            $.confirm({
                title: 'Confirm!',
                content: " Are you sure you want to delete this Adv ? ",
                buttons: {
                    confirm: {
                        text: 'Confirm',
                        btnClass: 'btn-orange',
                        ...
                        action: function () {
                            $.ajax({
                                type: "POST",
                                url: "<?php echo $base_url; ?>advertisement/remove",
                                data: {deleteid: Id},
                                beforeSend: function () {
                                    customBlockUI();
                                },
...
//                }
            ...
            table.dataTable({
                ...
                "processing": true,
                "serverSide": true,
                "sAjaxSource": "<?php echo base_url() . 'advertisement/DatatableRefresh'; ?>",
