                        ...
                        <div class="row mt-10">
                            <div class="col-md-12">
                                <div class="portlet light bordered">
                                    <form id="frmReorts" name="frmReorts" method="post" action="<?php echo base_url() . 'question_wise_report/exportReport' ?>">
            ...
            function DatatableRefresh() {
               ...
               // }
                ...
                table.dataTable({
                    ...
                    "columnDefs": [                        
                        {'className': 'dt-head-left dt-body-left','width': '80px','orderable': true,'searchable': true,'targets': [0]},
                        ...
                        {'className': 'dt-head-left dt-body-left','width': '130px','orderable': true,'searchable': true,'targets': [5]},
                    ...
                    "processing": true,
                    "serverSide": true,
                    "sAjaxSource": "<?php echo base_url() . 'question_wise_report/DatatableRefresh/'; ?>",
...
//                        aoData.push({name: 'to_range', value: $('#to_range').val()});
                    ...
                    "initComplete": function(settings, json) {
                        ...
                        $('thead > tr> th:nth-child(2)').css({ 'min-width': '200px', 'max-width': '150px' });
                        $('thead > tr> th:nth-child(3)').css({ 'min-width': '150px', 'max-width': '200px' });
                        $('thead > tr> th:nth-child(4)').css({ 'min-width': '60px', 'max-width': '200px' });
                        $('thead > tr> th:nth-child(5)').css({ 'min-width': '150px', 'max-width': '150px' });
                        $('thead > tr> th:nth-child(6)').css({ 'min-width': '100px', 'max-width': '150px' });
                        ...
                        $('thead > tr> th:nth-child(10)').css({ 'min-width': '150px', 'max-width': '150px' });
                    }
                });
            }
