                                                    ...
                                                    <div class="row"> 
                                                        ...
                                                        <div class="col-md-6">       
                                                            <div class="form-group">
                                                                ...
                                                                <span class="notranslate"><select id="company_id" name="company_id" class="form-control input-sm select2" placeholder="Please select" style="width:100%" disabled="">
                                                        ...
                                                        <div class="col-md-6">    
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="form_name" id="form_name" maxlength="255" class="form-control input-sm notranslate" value="<?php echo $HeadResult->form_name; ?>" >   
                                                            </div>
                                                        </div>
                                                    </div>                                                    
                                                    <div class="row">                                                               
                                                        <div class="col-md-6">    
                                                            <div class="form-group">
                                                                ...
                                                                <textarea rows="4" class="form-control input-sm notranslate" id="short_description" maxlength="255" name="short_description" placeholder="" ><?php echo $HeadResult->short_description; ?></textarea>
                                                                    ...
                                                                    if ($EditField > 0) {
                                                                        foreach ($Result as $fr) {
                                                                            ...
                                                                            <tr id="Row-<?php echo $key; ?>" class="notranslate">
                                                                                ...
                                                                                <td><span class="notranslate"><select id="field_type<?php echo $key; ?>" name="New_fieldtype_id[]" class="form-control input-sm select2" style="width:100%" onchange="addDATA(<?php echo $key; ?>)">    
                                                                                ...
                                                                                <td><span class="notranslate"><select id="New_field_status<?php echo $key; ?>" name="New_field_status[]" class="form-control input-sm select2" style="width:100%">
