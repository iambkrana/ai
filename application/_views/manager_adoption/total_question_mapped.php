...
<style>
    ...
    <div id='container'>
        <div id='total_question_mapped' style='min-width: 100%; height: 300px; background:white;'>
...
<?php }  else{ ?>
<div id='container'>
    <div id='total_question_mapped' style='min-width: 100%; height: 300px;'></div>
    <div class="clearfix"></div>
</div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        Highcharts.chart('total_question_mapped', {
            chart: {
                type: 'area',
                marginTop: 95,
                spacingBottom: 25,
            ...
            exporting: {
                ...
                csv: {
                    columnHeaderFormatter: function(item, key) {
                        if (!key) {
                            return 'Total Question Mapped Month'
                        }
                        return false
                    }
                },
                filename: 'Total Question Mapped ' +<?php echo $report_title ?>+ '',
                buttons: {
                    contextButton: {
