...
<style>
    ...
    <div id='container'>
        <div id='rep_mapped_user' style='min-width: 100%; height: 300px; background:white;'>
...
<?php }  else{ ?>
<div id='container'>
        <div id='rep_mapped_user' style='min-width: 100%; height: 300px;'></div>    
        <div class="clearfix"></div>
</div>
...
<script>
    ...
    $(document).ready(function () {   
        ...
        Highcharts.chart('rep_mapped_user', {
            chart: {
                type: 'area',
                marginTop: 80,
                spacingBottom: 25,
