...
<style>
    ...
    <div id='container'>
        <div id='AdoptionByReps' style='min-width: 100%; height: 300px; background:white;'>
...
<?php }  else{ ?>
<div id='container'>
    <div id='AdoptionByReps' style='min-width: 100%; height: 300px;'></div>
    <div class="clearfix"></div>
</div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        Highcharts.chart('AdoptionByReps', {
            chart: {
                type: 'bar',
                marginTop: 50,
                spacingBottom: 25,
            ...
            exporting: {
                ...
                filename: 'Adoption By Reps ' + <?php echo $report_title ?> + '',
                buttons: {
                    contextButton: {
                        symbol: 'download',
                        symbolStroke: "#004369",
