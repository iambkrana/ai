    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white">
        ...
        <script>
            function loadChart(){
                ...
                $('#top_five_loading').show();
                $('#bottom_five_loading').show();
                $.ajax({
                    type: "POST",
                    ...
                    async: false,
                    url: "<?php echo $base_url; ?>trainer_wksh_detail/load_chart",
                    success: function (response) {
                        if (response != '') {
                            ...
                            if (chart!=''){
                                ...
                                $("#top_five_panel").append(json['top_five_table']);
                                $("#bottom_five_panel").append(json['bottom_five_table']);
                                
                                $('#topic_wise_ce_loading').hide();
                                $('#top_five_loading').hide();
                                $('#bottom_five_loading').hide();
                            } 
                        }
                    }
                });
