                                                    ...
                                                    <div class="row">    
                                                        <div class="col-md-9">       
                                                            <div class="form-group">
                                                                <label class="">Category Name<span class="required"> * </span></label>
                ...
                frmModalForm.validate({
                    ...
                    rules: {
                        description: {
                            required: true,
                            remote: {
                                url: "<?php echo base_url();?>index.php/category/validate",
                                type: "post",
                                data: {
                                    id: function () {
                                        return $("#edit_id").val();
...
//                    },
                    ...
                    submitHandler: function (form) {
                        ...
                        $.post('<?php echo base_url();?>index.php/category/submit', $("#frmModalForm").serialize(), function (data) {
            ...
            function LoadCreateModal(){
                $('.modal-title').html('Create Category').show();
                $('#frmModalForm').trigger("reset");
                $("#frmModalForm").validate().resetForm();
                $("#status").select2("val", "1");
            ...
            function LoadEditModal(edit_id){
                ...
                $('.modal-title').html('Edit Category').show();
                $('#frmModalForm').trigger("reset");
                $("#frmModalForm").validate().resetForm();
                $("#status").select2("val", "1");
                $('#edit_id').val(edit_id);
                    ...
                    buttons: {
                        ...
                        action: function(){
                            $.ajax({
                                ...
                                url: "<?php echo $base_url; ?>category/record_actions/"+opt,
                                success: function (response_json) {
                                    var response= JSON.parse(response_json);
                                    ShowAlret(response.message,response.alert_type);
                                    DatatableRefresh();
                ...
                if (Check > 0){
                    if( opt == 1 ){
                       LoadConfirmDialog("Confirm Active Status ?",opt);  
                        ...
                        LoadConfirmDialog("Delete Selected Category(s) ?",opt);
                    }   
                }else{
            ...
            function LoadDeleteDialog(Description,Id){
                $.confirm({
                    title: 'Confirm!',
                    content: " Are you sure you want to delete category '"+Description+"' ? ",
                    buttons: {
                        confirm:{
                        text: 'Confirm',
                        btnClass: 'btn-orange',
...
//                }
                ...
                table.dataTable({
                    ...
                    "processing": true,
                    "serverSide": true,
                    "sAjaxSource": "<?php echo base_url() . 'category/DatatableRefresh'; ?>",
