                                                    ...
                                                    <div class="row">    
                                                        <div class="col-md-9">       
                                                            <div class="form-group">
                                                                <label class="">Industry Name<span class="required"> * </span></label>
...
<script src="<?php echo $base_url; ?>assets/global/plugins/datatables/Buttons-1.3.1/js/dataTables.buttons.min.js" type="text/javascript"></script>
        <script>
                ...
                frmModalForm.validate({
                    ...
                    rules: {
                        description: {
                            required: true,
                            remote: {
                                url: "<?php echo base_url();?>index.php/industry_type/validate",
                                type: "post",
                                data: {
                                    id: function () {
                                        return $("#edit_id").val();
                    ...
                    submitHandler: function (form) {
                        ...
                        form_success.show();
                        form_error.hide();
                        $.post('<?php echo base_url();?>index.php/industry_type/submit', $("#frmModalForm").serialize(), function (data) {
            ...
            function LoadCreateModal(){
                $('.modal-title').html('Create Industry').show();
                $('#frmModalForm').trigger("reset");
                $("#frmModalForm").validate().resetForm();
                $("#status").select2("val", "1");
            ...
            function LoadEditModal(edit_id){
                ...
                $('.modal-title').html('Edit Industry').show();
                $('#frmModalForm').trigger("reset");
                $("#frmModalForm").validate().resetForm();
                $("#status").select2("val", "1");
                $('#edit_id').val(edit_id);
                $.ajax({
                    ...
                    url: "<?php echo $base_url; ?>industry_type/edit",
                    beforeSend: function () {
                    	customBlockUI();
                    },
                    ...
                    buttons: {
                        ...
                        action: function(){
                            $.ajax({
                                ...
                                url: "<?php echo $base_url; ?>industry_type/record_actions/"+opt,
                                beforeSend: function () {
                                	customBlockUI();
                                },
                                success: function (response_json) {
                ...
                if (Check > 0){
                    if( opt == 1 ){
                       LoadConfirmDialog("Confirm Active Status ?",opt);  
                        ...
                        LoadConfirmDialog("Delete Selected Industry(s) ?",opt);
                    }   
                }else{
            ...
            function LoadDeleteDialog(Description,Id){
                $.confirm({
                    title: 'Confirm!',
                    content: " Are you sure you want to delete company type '"+Description+"' ? ",
                    buttons: {
                        confirm:{
                        text: 'Confirm',
                        btnClass: 'btn-orange',
                        ...
                        action: function(){
                            $.ajax({
                                type: "POST",
                                url: "<?php echo $base_url;?>industry_type/remove",
                                data: {deleteid:Id},
                                beforeSend: function () {
                                	customBlockUI();
                                },
...
//                }
                ...
                table.dataTable({
                    ...
                    "processing": true,
                    "serverSide": true,
                    "sAjaxSource": "<?php echo base_url() . 'industry_type/DatatableRefresh'; ?>",
