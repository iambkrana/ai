                    ...
                    <div class="page-bar">
                        ...
                        <?php if ($acces_management->allow_add) { ?>
                            <div class="page-toolbar">
                                <a class="btn btn-sm btn-orange pull-right" id="btnaddpanel3" href="<?php echo base_url() . 'workshopsubtype/LoadModal/' ?>" data-target="#LoadModalFilter" data-toggle="modal"><i class="fa fa-plus"></i>&nbsp;Create New </a>
                            </div>
                        <?php } ?>
                    </div>
                    <div class="row mt-10">
                                                ...
                                                <div class="row ">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9" style="padding:0px;">
                                                                <select id="filter_wtype_id" name="filter_wtype_id" class="notranslate form-control input-sm select2me filter_list " placeholder="Please select">
                                                                    <option class="notranslate" value="">Please Select</option>
                                                                    <?php if (count($WorkshopType) > 0) {
                                                                        foreach ($WorkshopType as $Row) { ?>
                                                                            <option name="option" value="<?php echo $Row->id ?>"><?php echo  $Row->workshop_type ?></option>
                                                                    <?php  }
                                                                    } ?>
                                                                </select>
                                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9" style="padding:0px;">
                                                                <select id="filter_status" name="filter_status" class="notranslate form-control input-sm select2me filter_list" placeholder="Please select">
            ...
            table.dataTable({
                ...
                "columnDefs": [{
                    ...
                    },
                    {
                        ...
                        'searchable': true,
                        'targets': [2],
                        "visible": <?php echo ($Company_id == "" ? 'true' : 'false'); ?>
                    },
                    {
                        'width': '200px',
                        'orderable': true,
                ...
                "fnServerData": function(sSource, aoData, fnCallback) {
                    ...
                    aoData.push({
                        name: 'filter_wtype_id',
                        value: $('#filter_wtype_id').val()
                    });
                    aoData.push({
                        name: 'filter_cmp_id',
                        value: $('#filter_cmp_id').val()
                    });
                    aoData.push({
                        name: 'filter_status',
