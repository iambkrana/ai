...
<style>
    ...
    <div id='container'>
        <div id='total_report_sent' style='min-width: 100%; height: 300px; background:white;'>
    ...
    $(document).ready(function() {
        ...
        Highcharts.chart('total_report_sent', {
            ...
            exporting: {
                ...
                filename: 'Total Report Sent ' +<?php echo $report_title ?>+ '',
                buttons: {
                    contextButton: {
