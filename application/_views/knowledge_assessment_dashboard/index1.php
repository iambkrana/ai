                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="portlet-title potrait-title-mar">
                                        <div class="caption">
                                            <i class="icon-bar-chart font-dark hide"></i>
                                            <span class="caption-subject font-dark bold uppercase">
                                                <h3 id="date_lable">Last Month</h3>
                                            </span>
                                        </div>
                                    </div>
                                    <!-- Last Month ROW -->
        ...
        <script>
            ...
            function getWeek() {
                $.ajax({
                    ...
                    async: false,
                    url: "<?php echo $base_url; ?>knowledge_assessment_dashboard/ajax_getWeeks",
                    beforeSend: function() {
                        customBlockUI();
                    },
            ...
            function dashboard_refresh() {
                ...
                $.ajax({
                    ...
                    //async: false,
                    url: "<?php echo $base_url; ?>knowledge_assessment_dashboard/getdashboardData",
                    beforeSend: function() {
                        customBlockUI();
                    },
            ...
            function supervisor_index_refresh() {
                ...
                $.ajax({
                    ...
                    //async: false,
                    url: "<?php echo $base_url; ?>knowledge_assessment_dashboard/load_supervisor_index/" + firsttimeload,
                    beforeSend: function() {
                        customBlockUI();
                    },
            ...
            function getCompanywiseData() {
                ...
                $.ajax({
                    ...
                    //async: false,
                    url: "<?php echo $base_url; ?>knowledge_assessment_dashboard/ajax_companywise_data",
                    beforeSend: function() {
                        customBlockUI();
                    },
                    success: function(msg) {
            ...
            function getTrainerwiseData() {
                $.ajax({
                    ...
                    //async: false,
                    url: "<?php echo $base_url; ?>knowledge_assessment_dashboard/ajax_trainerwise_data",
                    beforeSend: function() {
                        customBlockUI();
                    },
                    success: function(msg) {
            ...
            function getWTypewiseData() {
                $.ajax({
                    ...
                    //async: false,
                    url: "<?php echo $base_url; ?>knowledge_assessment_dashboard/ajax_wtypewise_data",
                    beforeSend: function() {
                        customBlockUI();
                    },
                    success: function(msg) {
            ...
            function getRegionwiseData() {
                $.ajax({
                    ...
                    //async: false,
                    url: "<?php echo $base_url; ?>knowledge_assessment_dashboard/ajax_regionwise_data",
                    beforeSend: function() {
                        customBlockUI();
                    },
                    success: function(msg) {
