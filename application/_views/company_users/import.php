...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                    ...
                    <div class="page-content">
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <span>Import Company Users</span>
                                </li>
                            </ul>
                        ...
                        <div class="row mt-10">
                            <div class="col-md-12">
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <form id="FrmCompanyUsers" name="FrmCompanyUsers" method="POST"  enctype="multipart/form-data" > 
                                                ...
                                                <div class="tab-pane active" id="tab_overview">    
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">    
                                                            <div class="form-group">
                                                                <label>&nbsp;</label>
                                                                <a href="<?php echo base_url() . 'company_users/userssamplexls' ?>" class="form-control" style="    border: none;height:auto;" ><strong>Download Sample Xls File</strong></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">      
                                            <div class="col-md-12 text-right">  
                                                <button type="button" id="cmpusers-submit" name="cmpusers-submit" data-loading-text="Please wait..." class="btn btn-orange mt-ladda-btn ladda-button mt-progress-demo" data-style="expand-left" onclick="SubmitData();" >
        ...
        <script>
                                                    var FrmCompanyUsers = $('#FrmCompanyUsers');
                                                    var form_error = $('.alert-danger', FrmCompanyUsers);
                                                    var form_success = $('.alert-success', FrmCompanyUsers);
                                                    jQuery(document).ready(function () {
                                                        $('.select2me').select2({
                                                            allowClear: true,
                                                            placeholder: 'Please Select'
                                                        });
                                                        FrmCompanyUsers.validate({
                                                            errorElement: 'span',
                                                        ...
                                                        $(".select2, .select2-multiple", FrmCompanyUsers).change(function () {
                                                            FrmCompanyUsers.validate().element($(this));
                                                        });
                                                    });
                                                    function SubmitData() {
                                                        $('#errordiv').hide();
                                                        if (!$('#FrmCompanyUsers').valid()) {
                                                            return false;
                                                        }
                                                        var file_data = $('#filename').prop('files')[0];
                                                        var form_data = new FormData();
                                                        form_data.append('filename', file_data);
                                                        var other_data = $('#FrmCompanyUsers').serializeArray();
                                                        ...
                                                        $.ajax({
                                                            ...
                                                            processData: false,
                                                            type: "POST",
                                                            url: '<?php echo site_url("company_users/UploadXls"); ?>',
                                                            data: form_data,
