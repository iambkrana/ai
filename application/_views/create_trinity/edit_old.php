                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="parameter_id[]" id="parameter_id" class="form-control myselect2 select2" placeholder="Please select" multiple="">
                                                    ...
                                                    <div class="row" id="QTable" style="display:none; overflow-x: scroll;overflow-y: hidden;">
                                                        <div class="col-md-12" style="width:100%;">
                                                            <table class="table table-bordered table-hover" id="VQADatatable" name="VQADatatable" style="width:100%;min-width:1200px;">
                                                                ...
                                                                <tbody id="QTable-body" class="notranslate"></tbody><!-- added by shital LM: 07:03:2024 -->
                                                            </table>
                                                        </div>
                                                    </div>
                                                    <div class="row">
