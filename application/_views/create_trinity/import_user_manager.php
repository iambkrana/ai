            ...
            <div class="form-body">
                <div class="row">
                    ...
                    <div class="col-md-6">    
                        <div class="form-group">
                            <label>&nbsp;</label>
                            <a href="<?php echo base_url() . 'create_trinity/user_manager_samplecsv' ?>" class="form-control" style="    border: none;height:auto;" ><strong>Download Sample csv File</strong></a>
                        </div>
                    </div>
                </div>
