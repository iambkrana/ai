                                                    ...
                                                    <div class="row">    
                                                        <div class="col-md-6">       
                                                            <div class="form-group">
                                                                ...
                                                                <select id="state_id" name="state_id" class="form-control input-sm select2" placeholder="Please select" style="width:100%">
        ...
        <script>
            ...
            jQuery(document).ready(function() {
                ...
                $('#state_id').select2({
                    ...
                    separator: ',',
                    ajax: {
                        url: "<?php echo base_url();?>index.php/city/ajax_populate_state",
                        dataType: 'json',
                        quietMillis: 100,
                    ...
                    initSelection: function(element, callback) {
                        return $.getJSON("<?php echo base_url();?>index.php/city/ajax_populate_state?id=" + (element.val()), null, function(data) {
                ...
                frmModalForm.validate({
                    ...
                    rules: {
                        description: {
                            required: true,
                            remote: {
                                url: "<?php echo base_url();?>index.php/city/validate",
                                type: "post",
                                data: {
                                    id: function () {
                                        return $("#edit_id").val();
...
//                    },
                    ...
                    submitHandler: function (form) {
                        ...
                        form_success.show();
                        form_error.hide();
                        $.post('<?php echo base_url();?>index.php/city/submit', $("#frmModalForm").serialize(), function (data) {
            ...
            function LoadCreateModal(){
                $('.modal-title').html('Create City').show();
                $('#frmModalForm').trigger("reset");
                $("#frmModalForm").validate().resetForm();
                $("#status").select2("val", "1");
                $('#edit_id').val('');
            ...
            function LoadEditModal(edit_id){
                $('.modal-title').html('Edit City').show();
                $('#frmModalForm').trigger("reset");
                $("#frmModalForm").validate().resetForm();
                $("#status").select2("val", "1");
                $('#edit_id').val(edit_id);
                $.ajax({
                    ...
                    success: function (response_json) {
                        ...
                        if (response.message==''){
                            $("#state_id").select2("trigger", "select", { 
                                data: { id: response.result[0].state_id,text:response.result[0].state_name} 
                            });
                    ...
                    buttons: {
                        ...
                        action: function(){
                            $.ajax({
                                ...
                                url: "<?php echo $base_url; ?>city/record_actions/"+opt,
                                success: function (response_json) {
                                    var response= JSON.parse(response_json);
                                    ShowAlret(response.message,response.alert_type);
                                    DatatableRefresh();
                ...
                if (Check > 0){
                    if( opt == 1 ){
                       LoadConfirmDialog("Confirm Active Status ?",opt);  
                        ...
                        LoadConfirmDialog("Delete Selected City(s) ?",opt);
                    }   
                }else{
            ...
            function LoadDeleteDialog(Description,Id){
                $.confirm({
                    title: 'Confirm!',
                    content: " Are you sure you want to delete city '"+Description+"' ? ",
                    buttons: {
                        confirm:{
                        text: 'Confirm',
                        btnClass: 'btn-orange',
                        ...
                        action: function(){
                            $.ajax({
                                type: "POST",
                                url: "<?php echo $base_url;?>city/remove",
                                data: {deleteid:Id},
                                success: function (response_json) {
                                    var response= JSON.parse(response_json);
                                    ShowAlret(response.message,response.alert_type);
...
//                }
                ...
                table.dataTable({
                    ...
                    "processing": true,
                    "serverSide": true,
                    "sAjaxSource": "<?php echo base_url() . 'city/DatatableRefresh'; ?>",
