                    ...
                    $lchtml ='<td ';
                        if(isset($reg[$parameter_id])){
                            ...
                            if($report_by == 1){
                                ...
                                $lchtml .= 'style="cursor: pointer;'.get_graphcolor($reg[$parameter_id]->result,2).'" onclick="get_parameterdata('.$parameter_id.','.$region_id.','.$report_type.');">';
                            }else{
                                //$lchtml .= 'style="cursor: pointer; '.get_graphcolor($reg[$parameter_id]->result,2).'" onclick="get_regionwisedata('.$parameter_id.','.$region_id.');">';
                                $lchtml .= 'style="cursor: pointer; '.get_graphcolor($reg[$parameter_id]->result,2).'" onclick="get_regionwisedata('.$parameter_id.','.$region_id.','.$report_type.');">';
                            }
