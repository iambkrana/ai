                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="assessment_name" id="assessment_name" maxlength="72" class="notranslate form-control input-sm" value="<?php echo $result->assessment; ?>">
                                                                                ...
                                                                                <select id="pdf_lang" name="pdf_lang" class="form-control input-sm select2 reports_rights" placeholder="Please select">
                                                                                    ...
                                                                                    if (count((array)$select_lang) > 0) {
                                                                                        foreach ($select_lang as $lang) { ?>
                                                                                            <option <?php if (isset($result->pdf_lang)) { echo ($lang->ml_id == $result->pdf_lang ? 'selected' : ''); } ?> value="<?php echo $lang->ml_id ?>"><?php echo $lang->ml_name ?></option>
                                                                                    <?php }
                                                                                    } ?>
                                                                                </select>
                                                                            </td>
                                                ...
                                                <form role="form" id="ParticipantForm" name="ParticipantForm">
                                                    <div class="form-body">
                                                        <div class="row margin-bottom-10">
                                                            <div class="col-md-12 text-right">
                                                                <button type="button" id="send_notification2" name="send_notification2" data-loading-text="Please wait..." class="btn orange btn-sm btn-outline" data-style="expand-right" onclick="notification_send(2);" style="margin-right: 10px;">
                                                                ...
                                                                <a class="btn btn-orange btn-sm" id="btnaddpanel3" href="<?php echo base_url() . 'assessment_create/importTrainee/' . base64_encode($result->id); ?>" data-target="#LoadModalFilter" data-toggle="modal"><i class="fa fa-file-excel-o"></i>&nbsp;Import </a>
                                                                &nbsp;

                                                                <a class="btn btn-orange btn-sm" id="btnaddpanel3" href="<?php echo base_url() . 'assessment_create/addParticipant/' . base64_encode($result->id); ?>" data-target="#LoadModalFilter" data-toggle="modal"><i class="fa fa-plus"></i>&nbsp;Add Participant User </a>
                                                            </div>
                                                        </div>
                                                        <div class="row ">
                                                    ...
                                                    <div class="form-body">
                                                        <div class="row margin-bottom-10">
                                                            ...
                                                            <div class="col-md-10 text-right">
                                                                ...
                                                                <a class="btn btn-orange btn-sm" id="btnaddpanel3" href="<?php echo base_url() . 'assessment_create/importManager/' . base64_encode($result->id); ?>" data-target="#LoadModalFilter" data-toggle="modal"><i class="fa fa-file-excel-o"></i>&nbsp;Import </a>
                                                                &nbsp;

                                                                <a class="btn btn-orange btn-sm" id="btnaddpanel3" href="<?php echo base_url() . 'assessment_create/addManagers/' . $result->division_id; ?>" data-target="#LoadModalFilter" data-toggle="modal"><i class="fa fa-plus"></i>&nbsp;Add Manager </a>
                                                            </div>
                                                        </div>
                                                        <div class="row ">
                                                            <div class="col-md-12" id="assessment_panel">
                                                    ...
                                                    <div class="form-body">
                                                        <div class="row margin-bottom-10">
                                                            ...
                                                            <div class="col-md-9 text-right">
                                                                ...
                                                                <a class="btn btn-orange btn-sm" id="btnaddpanel3" href="<?php echo base_url() . 'assessment_create/importSupervisor/' . base64_encode($result->id); ?>" data-target="#LoadModalFilter" data-toggle="modal"><i class="fa fa-file-excel-o"></i>&nbsp;Import </a>
                                                                &nbsp;

                                                                <a class="btn btn-orange btn-sm" id="btnaddpanel3" href="<?php echo base_url() . 'assessment_create/addSupervisors/' . $result->division_id; ?>" data-target="#LoadModalFilter" data-toggle="modal"><i class="fa fa-plus"></i>&nbsp;Add Supervisor </a>
                                                            </div>
                                                        </div>
                                                        <div class="row ">
                                                            <div class="col-md-12" id="assessment_panel">
                                                    ...
                                                    <div class="form-body">
                                                        <div class="row margin-bottom-10">
                                                            <div class="col-md-12 text-right">
                                                                ...
                                                                &nbsp;
                                                                <a class="btn btn-orange btn-sm" id="btnaddpanel3" href="<?php echo base_url() . 'assessment_create/addUserManagers/' . base64_encode($result->id); ?>" data-target="#LoadModalFilter" data-toggle="modal"><i class="fa fa-plus"></i>&nbsp;Add Assessor </a>

                                                                <a class="btn btn-orange btn-sm" id="btnaddpanel3" href="<?php echo base_url() . 'assessment_create/import_user_manager/' . base64_encode($result->id); ?>" data-target="#LoadModalFilter" data-toggle="modal"><i class="fa fa-file-excel-o"></i>&nbsp;Import </a>
                                                            </div>
                                                        </div>
                                                        <div class="row ">
                                                            <div class="col-md-12" id="assessment_panel">
