<div class="modal-header">
    ...
    <h4 class="modal-title">Mapping User Manager</h4>
...
<div class="modal-body">
            ...
            <div class="form-body">
                <div class="row">
                    <div class="col-md-6">    
                        <div class="form-group">
                            ...
                            <span class="text-muted">(only .xls &.csv allowed)</span>
                        </div>
                    </div>
                    <div class="col-md-6">    
                        <div class="form-group">
                            <label>&nbsp;</label>
                            <a href="<?php echo base_url() . 'assessment_create/user_manager_samplecsv' ?>" class="form-control" style="    border: none;height:auto;" ><strong>Download Sample csv File</strong></a>
                        </div>
                    </div>
                </div>
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        <ul>
                            <li>Upload Users Data through csv,xls file.</li>
                            <li> file format must be same as sample csv format.</li>
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-orange" onclick="UploadXlsUser_Manager();" >Confirm</button>
    </div>
