                     ...
                     <div class="portlet light bordered">
                        <div class="portlet-title potrait-title-mar">
                           ...
                           <div class="header-right" id="color-bar">
                              ...
                              <span style=" background:#e85159" class="color-boxes">Score < 54% </span>
                           </div>
                        </div>
                        <div class="portlet-body">
                  ...
                  <div class="row">
                     <div class="col-md-11">
                        <div class="form-group last">
                           <label>Modules</label>
                           <select id="hitmap_assessment_id" name="hitmap_assessment_id[]" class="form-control input-sm select2me" placeholder="Please select" multiple="">
                              <?php
                              if (isset($assessment)) {
