                                        ...
                                        <div class="modal-content">
                                            <form id="frmModalForm" name="frmModalForm" onsubmit="return false;"> 
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">Create Salutation</h4>
                                                </div>
                                                    ...
                                                    <div class="row">    
                                                        <div class="col-md-9">       
                                                            <div class="form-group">
                                                                <label class="">Salutation Name<span class="required"> * </span></label>
                ...
                frmModalForm.validate({
                    ...
                    rules: {
                        description: {
                            required: true,
                            remote: {
                                url: "<?php echo base_url();?>index.php/salutation/validate",
                                type: "post",
                                data: {
                                    id: function () {
                                        return $("#edit_id").val();
...
//                    },
                    ...
                    submitHandler: function (form) {
                        ...
                        $.post('<?php echo base_url();?>index.php/salutation/submit', $("#frmModalForm").serialize(), function (data) {
            ...
            function LoadCreateModal(){
                $('.modal-title').html('Create Salutation').show();
                $('#frmModalForm').trigger("reset");
                $("#frmModalForm").validate().resetForm();
                $("#status").select2("val", "1");
            ...
            function LoadEditModal(edit_id){
                ...
                $('.modal-title').html('Edit Salutation').show();
                $('#frmModalForm').trigger("reset");
                $("#frmModalForm").validate().resetForm();
                $("#status").select2("val", "1");
                $('#edit_id').val(edit_id);
                $.ajax({
                    ...
                    url: "<?php echo $base_url; ?>salutation/edit",
                    ...
                    buttons: {
                        ...
                        action: function(){
                            $.ajax({
                                ...
                                url: "<?php echo $base_url; ?>salutation/record_actions/"+opt,
                                success: function (response_json) {
                                    var response= JSON.parse(response_json);
                                    ShowAlret(response.message,response.alert_type);
                                    DatatableRefresh();
                ...
                if (Check > 0){
                    if( opt == 1 ){
                       LoadConfirmDialog("Confirm Active Status ?",opt);  
                        ...
                        LoadConfirmDialog("Delete Selected Salutation(s) ?",opt);
                    }   
                }else{
            ...
            function LoadDeleteDialog(Description,Id){
                $.confirm({
                    title: 'Confirm!',
                    content: " Are you sure you want to delete salutation '"+Description+"' ? ",
                    buttons: {
                        confirm:{
                        text: 'Confirm',
                        btnClass: 'btn-orange',
                        ...
                        action: function(){
                            $.ajax({
                                type: "POST",
                                url: "<?php echo $base_url;?>salutation/remove",
                                data: {deleteid:Id},
                                success: function (response_json) {
                                    var response= JSON.parse(response_json);
                                    ShowAlret(response.message,response.alert_type);
...
//                }
                ...
                table.dataTable({
                    ...
                    "columnDefs": [
                        ...
                        {'width': '30px','orderable': false,'searchable': false,'targets': [3]}, 
                        {'width': '65px','orderable': false,'searchable': false,'targets': [4]}, 
                    ],
                    "order": [
                        [1, "asc"]
                    ],
                    "processing": true,
                    "serverSide": true,
                    "sAjaxSource": "<?php echo base_url() . 'salutation/DatatableRefresh'; ?>",
