...
<script>
    ...
    function assessment_usercount(assessment_id) {
         var assess_id=assessment_id;
            ...
            $.ajax({
                url: base_url + "role_play_manager_dashboard/assessment_usercount",
                type: 'POST',
...
//                      {'width': '30px','orderable': true,'searchable': true,'targets': [0],"visible":false},
			{'className': 'dt-head-left dt-body-left','width': '130px','orderable': true,'searchable': false,'targets': [0]},
                    ...
                    "processing": true,
                    "serverSide": true,
                    "sAjaxSource": "<?php echo base_url() . 'role_play_manager_dashboard/QuestionScoreDatatable/'; ?>",
                    "fnServerData": function (sSource, aoData, fnCallback) {
                        ...
                        //aoData.push({name: 'report_type', value: value: $('#report_type').val() });
