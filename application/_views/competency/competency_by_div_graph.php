...
?>
    ...
    <div id='container'>
        <div id='competency_by_division' style='min-width: 100%; height: 300px; background:white;'>
...
<?php } else { ?>
    <div id='competency_by_division' style='min-width: 100%; height: 300px;'></div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            Highcharts.chart('competency_by_division', {
                chart: {
                    height: 300,
                    type: 'bar',
                    marginBottom: 80,
                ...
                exporting: {
                    chartOptions: {
                        title: {
                            text: 'Competency by division (Overall)',
                            align: 'left',
                            verticalAlign: 'top',
                            y: 4,
                            'style': {
                    ...
                    filename: 'Competency by division (Overall)',
                    buttons: {
                        contextButton: {
                            symbol: 'download',
                            symbolStroke: "#004369",
