...
?>
    ...
    <div id='container'>
        <div id='competency_by_manager' style='min-width: 100%; height: 300px; background:white;'>
...
<?php } else { ?>
    <div id='competency_by_manager' style='min-width: 100%; height: 300px;'></div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            Highcharts.chart('competency_by_manager', {
                chart: {
                    height: 300,
                    type: 'bar',
                    marginBottom: 80,
                ...
                xAxis: {
                    ...
                    categories: <?php echo $manager_name; ?>,
                    labels: {
                        formatter: function() {
                ...
                exporting: {
                    chartOptions: {
                        title: {
                            text: 'Competency by manager (Overall)',
                            align: 'left',
                            verticalAlign: 'top',
                            y: 4,
                            'style': {
                    ...
                    filename: 'Competency by manager (Overall)',
                    buttons: {
                        contextButton: {
                            symbol: 'download',
                            symbolStroke: "#004369",
