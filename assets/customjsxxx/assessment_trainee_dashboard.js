function dashboard_refresh() {
    ...
    $.ajax({
        ...
        //async: false,
        url: base_url + "assessment_trainee_dashboard/getdashboardData",
        beforeSend: function () {
            customBlockUI();
        },
...
function getWeek(){
    $.ajax({
        ...
        async: false,
        url: base_url +"assessment_trainee_dashboard/ajax_getWeeks",
        beforeSend: function () {
            customBlockUI();
        },
    ...
    $.ajax({
        type: "POST",
         data: {company_id: $('#company_id').val(), report_by: $('#report_by').val(), rpt_period:$('#rpt_period').val(),parameter_id:$('#parameter_id').val(),
			month:$('#month').val(),year:$('#year').val(),week:$('#week').val(),StartDate: StartDate, EndDate: EndDate, user_id: $('#user_id').val()},
        //async: false,
        url: base_url +"assessment_trainee_dashboard/load_assessment_index",
        beforeSend: function () {
            customBlockUI();
        },
    ...
    $.ajax({
        type: "POST",
         data: {report_by: $('#report_by').val(), rpt_period:$('#rpt_period').val(),parameter_id:$('#parameter_id').val(), report_type: $('#report_type').val(),
             month:$('#month').val(),year:$('#year').val(),week:$('#week').val(),StartDate: StartDate, EndDate: EndDate, user_id: $('#user_id').val()},
        //async: false,
        url: base_url +"assessment_trainee_dashboard/load_parameter_index",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (response) {
