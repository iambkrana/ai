...
function getWeek() {
    $.ajax({
        ...
        async: false,
        url: base_url + "reports_adoption/ajax_getWeeks",
        beforeSend: function () {
            customBlockUI();
        },
...
function assessment_started(IsCustom) {
    ...
    $.ajax({
        ...
        url: base_url + "reports_adoption/assessment_started",
        beforeSend: function () {
            customBlockUI();
        },
...
function assessment_complted(IsCustom) {
    ...
    $.ajax({
        ...
        //async: false,
        url: base_url + "reports_adoption/assessment_complted",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (response) {
...
function raps_mapped_user(IsCustom) {
    ...
    $.ajax({
        ...
        url: base_url + "reports_adoption/get_raps_mapped_user",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (response) {
...
function total_users_Ac_In(IsCustom) {
    ...
    $.ajax({
        ...
        //async: false,
        url: base_url + "reports_adoption/total_users_Ac_In",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (response) {
...
function RapsPlayedCompleted(IsCustom) {
    ...
    $.ajax({
        ...
        url: base_url + "reports_adoption/get_raps_played_completed",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (response) {
...
function total_video_uploded(IsCustom) {
    ...
    $.ajax({
        ...
        //async: false,
        url: base_url + "reports_adoption/total_video_uploded",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (response) {
...
function total_video_processed(IsCustom) {
    ...
    $.ajax({
        ...
        //async: false,
        url: base_url + "reports_adoption/total_video_processed",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (response) {
...
function Total_Report_Sent(IsCustom) {
    ...
    $.ajax({
        ...
        //async: false,
        url: base_url + "reports_adoption/total_report_sent",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (response) {
...
function Adoption_by_team() {
    ...
    $.ajax({
        ...
        //async: false,
        url: base_url + "reports_adoption/adoption_by_team",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (response) {
...
function Adoption_by_division(IsCustom) {
    ...
    $.ajax({
        ...
        //async: false,
        url: base_url + "reports_adoption/adoption_by_divison",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (response) {
...
//         },
//         //async: false,
//         url: base_url + "reports_adoption/adoption_by_module",
//         beforeSend: function () {
//             customBlockUI();
//         },
//         success: function (response) {
...
function adoption_by_region(IsCustom) {
    ...
    $.ajax({
        ...
        //async: false,
        url: base_url + "reports_adoption/adoption_by_region",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (response) {
...
function adoptionbymodule() {
    ...
    $.ajax({
        ...
        //async: false,
        url: base_url + "reports_adoption/adoption_by_module_new",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (response) {
...
function Adoption_by_division_overall(IsCustom) {
    ...
    $.ajax({
        ...
        //async: false,
        url: base_url + "reports_adoption/adoption_by_divison_overall",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (response) {
...
function Getassessment_wise_d_r_m() {
    ...
    $.ajax({
        ...
        //async: false,
        url: base_url + "reports_adoption/Getassessment_wise_d_r_m",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (msg) {
...
function adoption_by_manager() {
    ...
    $.ajax({
        ...
        //async: false,
        url: base_url + "reports_adoption/adoption_by_manager",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (response) {
...
function ad_by_region() {
    ...
    $.ajax({
        ...
        //async: false,
        url: base_url + "reports_adoption/ad_by_region",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (MSG) {
...
function load_ad_by_region_filter(r_id) {
    ...
    $.ajax({
        ...
        //async: false,
        url: base_url + "reports_adoption/adoption_by_region_filters",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (msg) {
