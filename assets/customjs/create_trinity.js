...
jQuery.validator.addMethod(
  ...
  function (value, element) {
    ...
    $.ajax({
      ...
      url: Base_url + "create_trinity/numeric_check",
      async: false,
      success: function (msg) {
        abc = msg != "" ? false : true;
      },
...
//     return this.optional(element) || /^[\p{L}\p{N}\p{Z}]+$/u.test(value);
      ...
      if (Data["success"]) {
        ...
        setTimeout(function () {
          ...
          window.location.href =
            Base_url + "create_trinity/edit/" + Encode_id + "/1.2";
        }, 500);
      } else {
        $("#errordiv").show();
      ...
      if (Data["success"]) {
        ...
        if (AddEdit == "A" || AddEdit == "C") {
          setTimeout(function () {
            // wait for 5 secs(2)
            window.location.href =
              Base_url + "create_trinity/edit/" + Data["id"] + "/1.2";
          }, 500);
        } else {
          questionTable();
        }
