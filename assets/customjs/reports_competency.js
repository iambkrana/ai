function dashboard_refresh() {
    ...
    //     //async: false,
    //     url: base_url + "reports_competency/getdashboardData",
    // beforeSend: function () {
    //     customBlockUI();
    // },
...
function getWeek() {
    $.ajax({
        ...
        async: false,
        url: base_url + "reports_competency/ajax_getWeeks",
        beforeSend: function () {
            customBlockUI();
        },
...
function performance_comparison() {
    ...
    $.ajax({
        ...
        //async: false,
        url: base_url + "reports_competency/performance_comparison",
        beforeSend: function () {
            customBlockUI();
        },
...
function performance_division() {
    ...
    $.ajax({
        ...
        //async: false,
        url: base_url + "reports_competency/performance_comparison_by_division",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (response) {
...
function competency_by_division(IsCustom) {
    ...
    $.ajax({
        ...
        //async: false,
        url: base_url + "reports_competency/competency_by_division",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (response) {
...
function competency_by_region(IsCustom) {
    ...
    $.ajax({
        ...
        //async: false,
        url: base_url + "reports_competency/competency_by_region",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (response) {
...
function Competency_understanding_graph() {
    ...
    $.ajax({
        ...
        //async: false,
        url: base_url + "reports_competency/Competency_understanding_graph",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (response) {
...
function performance_region() {
    ...
    $.ajax({
        ...
        //async: false,
        url: base_url + "reports_competency/performance_comparison_by_region",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (response) {
...
function region_wise_performance() {
    ...
    $.ajax({
        ...
        //async: false,
        url: base_url + "reports_competency/region_wise_performance",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (response) {
...
function get_top_five_region() {
    ...
    $.ajax({
        ...
        data: {},
        //async: false,
        url: base_url + "reports_competency/get_top_five_region_data",
...
function get_bottom_five_region() {
    ...
    $.ajax({
        ...
        data: {},
        //async: false,
        url: base_url + "reports_competency/get_bottom_five_region_data",
        beforeSend: function (f) {
...
function Getheatmapregion() {
    ...
    $.ajax({
        ...
        url: base_url + "reports_competency/heat_wise_region",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (msg) {
...
function get_regionwisedata(assessment_id, region_id, report_type) {
    $.ajax({
        url: base_url + "reports_competency/region_scoredata",
        type: 'POST',
...
function Getassessment_wise_d_r_m() {
    ...
    $.ajax({
       ...
       //async: false,
       url:  base_url+"reports_competency/Getassessment_wise_d_r_m",
       beforeSend: function() {
          customBlockUI();
       },
       success: function(msg) {
...
function competency_by_manager() {
    ...
    $.ajax({
        ...
        //async: false,
        url:  base_url+"reports_competency/competency_by_manager",
        beforeSend: function () {
            customBlockUI();
        },
        success: function (response) {
...
function get_time_wise_manager(IsCustom){
    ...
    $.ajax({
        ...
        //async: false,
        url:  base_url+"reports_competency/time_wise_manager",
        beforeSend: function () {
            customBlockUI();
        },
        success: function(msg) {
